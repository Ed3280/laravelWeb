  ...
  <div class="topbar">
    <div class="container-fluid d-flex align-items-center">
      ...
      <nav class="nav nav-gap-x-1 ml-auto mr-1">
        ...
        <div class="nav-item nav-pills dropdown">
          <a class="nav-link nav-link-sm dropdown-toggle no-caret hover" href="#" id="langDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-display="static">
            English
          </a>
      ...
      <nav class="nav nav-main nav-gap-x-1 nav-pills ml-3 d-none d-lg-flex">
        ...
        <div class="nav-item dropdown dropdown-hover">
          ...
          <div class="dropdown-menu" aria-labelledby="accountDropdown">
            <a class="dropdown-item active" href="account-signin.html">Sign In / Sign Up</a>
        ...
        <div class="modal-body px-0 scrollbar-width-thin">
          <ul class="menu" id="menu">
            ...
            <li>
              ...
              <ul>
                <li class="mm-active"><a href="account-signin.html">Sign In / Sign Up</a></li>

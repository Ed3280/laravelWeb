...
<body>
      ...
      <nav class="nav nav-main nav-gap-x-1 nav-pills ml-3 d-none d-lg-flex">
        ...
        <div class="nav-item dropdown dropdown-hover">
          ...
          <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            ...
            <a class="dropdown-item active" href="404.html">404 Not Found</a>
          </div>
        </div>
  ...
  <div class="container-fluid my-4 text-center">
    ...
    <img src="/assets/shop/img/404.jpg" alt="404" width="250" class="img-fluid rounded-circle mb-3 img-thumbnail border-info">
          ...
          <ul class="menu" id="menu">
            ...
            <li>
              ...
              <ul>
                ...
                <li class="mm-active"><a href="404.html">404 Not Found</a></li>
              </ul>
            </li>

...
<body>
  ...
  <header>
    <div class="container-fluid">
      ...
      <nav class="nav nav-main nav-gap-x-1 nav-pills ml-3 d-none d-lg-flex">
        ...
        <div class="nav-item dropdown dropdown-hover">
          <a class="nav-link dropdown-toggle no-caret forwardable active" href="blog-grid.html" id="blogDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            Blog
          </a>
          <div class="dropdown-menu" aria-labelledby="blogDropdown">
            <a class="dropdown-item" href="blog-grid.html">Post Grid</a>
            <a class="dropdown-item" href="blog-list.html">Post List</a>
            <a class="dropdown-item active" href="blog-single.html">Single Post</a>
          </div>
        </div>
        <div class="nav-item dropdown dropdown-hover">
  ...
  <div class="container-fluid mb-3">
    <div class="row gutters-3">
        ...
        <div class="card card-style1">
          <div class="card-body" lang="zxx"> <!-- because 'lorem ipsum' is not english language, so we add lang="zxx" attribute, remove it on production environment -->
            ...
            <div class="d-flex align-items-center small mb-3">
              <i class="material-icons font-size-base mr-1">access_time</i> Jan 01, 19
              <a href="javascript:void(0)" class="d-flex align-items-center text-muted ml-3">
                <i class="material-icons font-size-base mr-1">person</i> Admin
              </a>
              <a href="javascript:void(0)" class="d-flex align-items-center text-muted ml-3">
                <i class="material-icons font-size-base mr-1">label</i> Fashion
              </a>
            </div>

            <!-- Blog Content -->
            <h2>5 Coolest Winter Outfits You Can Steal</h2>
            <img src="/assets/shop/img/blog/blog-single.jpeg" alt="Blog" class="img-fluid w-100 my-3">
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nulla ipsa fuga et tenetur dolore, maxime consequuntur! Adipisci sed eligendi reprehenderit alias, beatae perspiciatis, id dolore laborum aliquam praesentium excepturi odio quas aut enim, libero sit minus blanditiis veritatis repellat cum suscipit non obcaecati qui iure? Voluptates a perspiciatis sunt quaerat.</p>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quas asperiores rem dolorem vitae reiciendis rerum, id a dicta labore ea, est sed odio animi nostrum veniam, inventore vel. Delectus, ex, qui. Quidem ea, natus aut nihil quaerat suscipit vel fuga numquam excepturi nemo minus quae at, ab qui rerum cum!</p>
            <ul>
            ...
            <div class="media my-4">
              <a href="javascript:void(0)"><img src="/assets/shop/img/user/user.svg" alt="User" width="45" height="45" class="rounded-circle"></a>
              <div class="media-body ml-2 ml-sm-3">
                <textarea rows="2" placeholder="Leave a comment" class="form-control border rounded-0 shadow-none autosize"></textarea>
                <button class="btn btn-sm btn-light border border-top-0 btn-block rounded-0 shadow-none">Post</button>
              </div>
            </div>
            <div class="media">
              ...
              <div class="media-body ml-2 ml-sm-3">
                <div class="d-flex align-items-center">
                  <a href="javascript:void(0)" class="mr-2">Alex</a>
                  <span class="font-size-sm text-muted">17 minutes ago</span>
                </div>
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Et suscipit vitae eius incidunt odit nulla, repellat harum, repudiandae doloremque expedita.</p>
                <ul class="list-inline font-size-sm">
                  <li class="list-inline-item"><a href="javascript:void(0)" class="text-muted text-decoration-none" title="vote up">5 <i class="material-icons align-bottom">keyboard_arrow_up</i></a></li>
                  <li class="list-inline-item"><a href="javascript:void(0)" class="text-muted text-decoration-none" title="vote down"><i class="material-icons align-bottom">keyboard_arrow_down</i></a></li>
                  <li class="list-inline-item"><a href="javascript:void(0)" class="text-muted text-decoration-none">Reply</a></li>
                </ul>
                <hr>
                <div class="media">
                  ...
                  <div class="media-body ml-2 ml-sm-3">
                    <div class="d-flex align-items-center">
                      <a href="javascript:void(0)" class="mr-2">Twink</a>
                      <span class="font-size-sm text-muted">5 minutes ago</span>
                    </div>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Et suscipit vitae eius incidunt odit nulla, repellat harum, repudiandae doloremque expedita.</p>
                    <ul class="list-inline font-size-sm">
                      <li class="list-inline-item"><a href="javascript:void(0)" class="text-muted text-decoration-none" title="vote up"><i class="material-icons align-bottom">keyboard_arrow_up</i></a></li>
                      <li class="list-inline-item"><a href="javascript:void(0)" class="text-muted text-decoration-none" title="vote down"><i class="material-icons align-bottom">keyboard_arrow_down</i></a></li>
                      <li class="list-inline-item"><a href="javascript:void(0)" class="text-muted text-decoration-none">Reply</a></li>
                    </ul>
                    <hr>
            ...
            <div class="media">
              <a href="javascript:void(0)"><img src="/assets/shop/img/user/user3.svg" alt="User" width="45" height="45" class="rounded-circle"></a>
              <div class="media-body ml-2 ml-sm-3">
                <div class="d-flex align-items-center">
                  <a href="javascript:void(0)" class="mr-2">Steve</a>
                  <span class="font-size-sm text-muted">an hour ago</span>
                </div>
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Et suscipit vitae eius incidunt odit nulla, repellat harum, repudiandae doloremque expedita.</p>
                <ul class="list-inline font-size-sm">
                  <li class="list-inline-item"><a href="javascript:void(0)" class="text-muted text-decoration-none" title="vote up"><i class="material-icons align-bottom">keyboard_arrow_up</i></a></li>
      ...
      <div class="col-md-4 col-xl-3">
        <div class="d-grid grid-template-col-1 grid-template-col-sm-2 grid-template-col-md-1 grid-gap-3 mt-3 mt-md-0">
  <div class="card card-style1">
    <h5 class="card-header">POPULAR THIS<span class="text-primary ml-2">WEEK</span></h5>
    <div class="card-body">
      <ul class="list-group list-group-flush list-group-sms">
        <li class="list-group-item px-0">
          <div class="media">
            <a href="blog-single.html" class="w-25">
              <img src="/assets/shop/img/blog/1.jpeg" class="img-fluid" alt="blog">
            </a>
            <div class="media-body ml-3">
              <a href="blog-single.html" class="card-link text-secondary">5 Coolest Winter Outfits You Can Steal</a>
            </div>
          </div>
        </li>
        <li class="list-group-item px-0">
          <div class="media">
            <a href="blog-single.html" class="w-25">
              <img src="/assets/shop/img/blog/2.jpeg" class="img-fluid" alt="blog">
            </a>
            <div class="media-body ml-3">
              <a href="blog-single.html" class="card-link text-secondary">How to Pick the Right Men's Shirt</a>
            </div>
          </div>
        </li>
        <li class="list-group-item px-0">
          <div class="media">
            <a href="blog-single.html" class="w-25">
              <img src="/assets/shop/img/blog/3.jpeg" class="img-fluid" alt="blog">
            </a>
            <div class="media-body ml-3">
              <a href="blog-single.html" class="card-link text-secondary">5 Simple Outfits for Men</a>
            </div>
          </div>
        </li>
        <li class="list-group-item px-0">
          <div class="media">
            <a href="blog-single.html" class="w-25">
              <img src="/assets/shop/img/blog/4.jpeg" class="img-fluid" alt="blog">
            </a>
            <div class="media-body ml-3">
              <a href="blog-single.html" class="card-link text-secondary">Business Casual Outfit Ideas</a>
            </div>
          </div>
        </li>
      </ul>
  ...
  <div class="card card-style1">
    <h5 class="card-header">POPULAR<span class="text-primary ml-2">TAGS</span></h5>
    <div class="card-body">
      <div class="btn-group-scatter">
        <a href="javascript:void(0)" class="btn btn-faded-light rounded-pill mb-1">Design</a>
        <a href="javascript:void(0)" class="btn btn-faded-light rounded-pill mb-1">Fashion</a>
        <a href="javascript:void(0)" class="btn btn-faded-light rounded-pill mb-1">Beauty</a>
        <a href="javascript:void(0)" class="btn btn-faded-light rounded-pill mb-1">Travel</a>
        <a href="javascript:void(0)" class="btn btn-faded-light rounded-pill mb-1">Sport</a>
        <a href="javascript:void(0)" class="btn btn-faded-light rounded-pill mb-1 active">Active tag</a>
        <a href="javascript:void(0)" class="btn btn-faded-light rounded-pill mb-1">Cooking</a>
        <a href="javascript:void(0)" class="btn btn-faded-light rounded-pill mb-1">Technology</a>
      </div>
    </div>
  </div>
</div>
          ...
          <ul class="menu" id="menu">
            ...
            <li>
              ...
              <ul>
                ...
                <li class="mm-active"><a href="blog-single.html">Single Post</a></li>
              </ul>
            </li>
            <li>
  ...
  <!-- Plugins -->
  <script src="/assets/shop/plugins/autosize/autosize.min.js"></script>

          ...
          <div class="dropdown-menu" aria-labelledby="shopDropdown">
            ...
            <div class="dropdown-submenu">
              ...
              <div class="dropdown-menu">
                ...
                <a class="dropdown-item active" href="checkout-review.html">Checkout - Review</a>
        ...
        <div class="card card-style1">
          <div class="card-body">
            <nav class="steps">
              ...
              <a href="checkout-payment.html" data-step="2" class="done">Payment</a>
              <a href="checkout-review.html" data-step="3" class="current">Review</a>
            </nav>
            <hr>
            <h5>Order Items :</h5>
          ...
          <div class="card-body">
            <div class="font-condensed">
              ...
              <div class="text-muted">
                John Thor<br>
                2114 Jadewood Farms 8854<br>
                john.thor@example.com<br>
                1-787-376-1552
              </div>
              <hr>
              <h5>Payment Method :</h5>
              <div class="text-muted">Credit Card : **** **** **** 4567</div>
              <hr>
              <div class="d-flex">
            ...
            <a href="checkout-complete.html" class="btn btn-lg btn-primary btn-block has-icon">COMPLETE ORDER<i class="material-icons">chevron_right</i></a>
          </div>
        </div>
      </div>
    </div>
              ...
              <ul>
                ...
                <li>
                  ...
                  <ul>
                    ...
                    <li class="mm-active"><a href="checkout-review.html">Checkout Review</a></li>

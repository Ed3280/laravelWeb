...
<body>
      ...
      <nav class="nav nav-main nav-gap-x-1 nav-pills ml-3 d-none d-lg-flex">
        <div class="nav-item dropdown dropdown-hover">
          ...
          <div class="dropdown-menu" aria-labelledby="homeDropdown">
            <a class="dropdown-item active" href="../../../index.php">Layout 1</a>
  ...
  <div class="swiper-container" id="homeSlider">
    <div class="swiper-wrapper">
      <div class="swiper-slide" data-cover="/assets/shop/img/slider/1.jpg" data-height="220px 350px 400px 430px 460px">
      ...
      <div class="swiper-slide" data-cover="/assets/shop/img/slider/2.jpg" data-height="220px 350px 400px 430px 460px">
      ...
      <div class="swiper-slide" data-cover="/assets/shop/img/slider/3.jpg" data-height="220px 350px 400px 430px 460px">
        <div class="overlay-content overlay-show align-items-end text-white">
          <div class="text-center">
  ...
  <div class="container-fluid mt-3">
    ...
    <div class="d-grid grid-template-col-2 column-gap-1 column-gap-sm-3 mt-1 mt-sm-3">
      <div class="img img-zoom-in">
        <img src="/assets/shop/img/categories/sunglasses.jpg" class="img-fluid w-100" alt="sunglasses">
        <div class="overlay overlay-show bg-dark"></div>
      ...
      <div class="img img-zoom-in">
        <img src="/assets/shop/img/categories/backpack.jpg" class="img-fluid w-100" alt="backpack">
        <div class="overlay overlay-show bg-dark"></div>
        <div class="overlay-content overlay-show flex-column text-white text-center">
          ...
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <div class="d-md-grid grid-template-col-md-2">
                <a href="shop-single.html" class="d-block" data-cover="/assets/shop/img/products/flash_deals_1.jpg" data-height="300px 240px 240px 220px 250px"></a>
            ...
            <div class="swiper-slide">
              <div class="d-md-grid grid-template-col-md-2">
                <a href="shop-single.html" class="d-block" data-cover="/assets/shop/img/products/flash_deals_2.jpg" data-height="300px 240px 240px 220px 250px"></a>
                <div class="text-center p-3">
    ...
    <div class="d-grid grid-template-col-2 grid-template-col-md-3 grid-gap-1 grid-gap-sm-3 mt-3">
      <div class="img img-zoom-in grid-column-start-1 grid-column-end-3 grid-column-end-sm-2 grid-row-start-sm-1 grid-row-end-sm-3">
        <div data-cover="/assets/shop/img/discover/1.jpeg" data-height="150px 276px 250px 325px 400px"></div>
        <div class="overlay overlay-show bg-dark"></div>
      ...
      <div class="img img-zoom-in">
        <div data-cover="/assets/shop/img/discover/2.jpeg" data-height="125px 100% 100% 100% 100%"></div>
        <div class="overlay overlay-show bg-dark"></div>
        <div class="overlay-content overlay-show">
      ...
      <div class="img img-zoom-in">
        <div data-cover="/assets/shop/img/discover/3.jpeg" data-height="125px 100% 100% 100% 100%"></div>
        <div class="overlay overlay-show bg-dark"></div>
        <div class="overlay-content overlay-show">
      ...
      <div class="img img-zoom-in">
        <div data-cover="/assets/shop/img/discover/4.jpeg" data-height="125px 130px 100% 100% 100%"></div>
        <div class="overlay overlay-show bg-dark"></div>
        <div class="overlay-content overlay-show">
      ...
      <div class="img img-zoom-in">
        <div data-cover="/assets/shop/img/discover/5.jpeg" data-height="125px 130px 100% 100% 100%"></div>
        <div class="overlay overlay-show bg-dark"></div>
        <div class="overlay-content overlay-show">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body px-0 scrollbar-width-thin">
          <ul class="menu" id="menu">
            <li class="no-sub mm-active"><a href="../../../index.php"><i class="material-icons">home</i> Home</a></li>

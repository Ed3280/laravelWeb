      ...
      <nav class="nav nav-main nav-gap-x-1 nav-pills ml-3 d-none d-lg-flex">
        ...
        <div class="nav-item dropdown dropdown-hover">
          ...
          <div class="dropdown-menu" aria-labelledby="accountDropdown">
            ...
            <a class="dropdown-item active" href="account-wishlist.html">Wishlist</a>
      ...
      <div class="col-md-4 col-lg-3">
        <div class="card card-style1">
          ...
          <div class="list-group list-group-flush">
            ...
            <a href="account-orders.html" class="list-group-item list-group-item-action d-flex">
              <i class="material-icons mr-3">shopping_cart</i> Orders
            </a>
            <a href="account-wishlist.html" class="list-group-item list-group-item-action d-flex align-items-center active">
          ...
          <div class="card-body">
            ...
            <ul class="list-group list-group-flush list-group-sm mt-3">
              ...
              <li class="list-group-item px-0 d-flex align-items-center">
                <div class="media">
                  <a href="shop-single.html">
                    <img src="/assets/shop/img/products/8_small.jpg" alt="product" width="75">
                  </a>
                  <div class="media-body ml-3">
                    <a href="shop-single.html" class="card-link text-secondary">Slim-Fit Short-Sleeve Printed Shirt</a>
                    <div class="price"><span>$25.00</span></div>
                    <button class="btn btn-sm btn-faded-primary mt-1 atc-demo" data-title="Slim-Fit Short-Sleeve Printed Shirt">Add to Cart</button>
                  </div>
                </div>
                <button class="btn btn-icon btn-sm btn-text-danger rounded-circle ml-auto" type="button"><i class="material-icons">close</i></button>
              </li>
              <li class="list-group-item px-0 d-flex align-items-center">
                <div class="media">
                  ...
                  <div class="media-body ml-3">
                    ...
                    <button class="btn btn-sm btn-faded-primary mt-1 atc-demo" data-title="Open Front Cropped Cardigans">Add to Cart</button>
                  </div>
                </div>
                <button class="btn btn-icon btn-sm btn-text-danger rounded-circle ml-auto" type="button"><i class="material-icons">close</i></button>
              </li>
          ...
          <ul class="menu" id="menu">
            ...
            <li>
              ...
              <ul>
                ...
                <li class="mm-active"><a href="account-wishlist.html" class="has-badge">Wishlist <span class="badge badge-primary badge-pill">3</span></a></li>

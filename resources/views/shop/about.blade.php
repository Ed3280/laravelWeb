      ...
      <div class="card-body">
        ...
        <div class="row">
          <div class="col-md-6 mb-3 mb-md-0">
            <img src="/assets/shop/img/about-us/about-us.jpg" alt="About Us" class="w-100">
          </div>
          <div class="col-md-6">
            <h2>About Us</h2>
        ...
        <div class="row">
          <div class="col-md-6 mb-3 mb-md-0 order-md-2">
            <img src="/assets/shop/img/about-us/our-purpose.jpg" alt="Our Purpose" class="w-100">
          </div>
        ...
        <div class="row">
          <div class="col-md-6 mb-3">
            <div class="media">
              <img class="rounded-circle mr-3" src="/assets/shop/img/about-us/serve.jpg" width="64" height="64" alt="We Serve">
          ...
          <div class="col-md-6 mb-3">
            <div class="media">
              <img class="rounded-circle mr-3" src="/assets/shop/img/about-us/run.jpg" width="64" height="64" alt="We Run">
              <div class="media-body">
                <h5>We Run</h5>
          ...
          <div class="col-md-6 mb-3">
            <div class="media">
              <img class="rounded-circle mr-3" src="/assets/shop/img/about-us/adapt.jpg" width="64" height="64" alt="We Adapt">
              <div class="media-body">
                <h5>We Adapt</h5>
          ...
          <div class="col-md-6 mb-3">
            <div class="media">
              <img class="rounded-circle mr-3" src="/assets/shop/img/about-us/commit.jpg" width="64" height="64" alt="We Commit">
              <div class="media-body">
                <h5>We Commit</h5>
        ...
        <div class="modal-body px-0 scrollbar-width-thin">
          <ul class="menu" id="menu">
            ...
            <li>
              ...
              <ul>
                <li class="mm-active"><a href="about.html">About Us</a></li>

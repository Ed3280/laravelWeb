      ...
      <nav class="nav nav-main nav-gap-x-1 nav-pills ml-3 d-none d-lg-flex">
        ...
        <div class="nav-item dropdown dropdown-hover">
          ...
          <div class="dropdown-menu" aria-labelledby="blogDropdown">
            ...
            <a class="dropdown-item active" href="blog-list.html">Post List</a>
      ...
      <div class="col-md-8 col-xl-9">
        <div class="card card-style1">
          <div class="card-body d-flex align-items-center py-2">
            ...
            <a href="blog-grid.html" data-toggle="tooltip" title="Show Grid" class="btn btn-sm btn-text-primary btn-icon rounded-circle"><i class="material-icons">apps</i></a>
            <a href="blog-list.html" data-toggle="tooltip" title="Show List" class="btn btn-sm btn-text-primary btn-icon rounded-circle active ml-1"><i class="material-icons">list</i></a>
          </div>
        </div>
        <div class="card card-style1 mt-3">
          <div class="card-body p-0">
            <div class="media align-items-stretch">
              <a href="blog-single.html" class="img img-zoom-in w-25">
                <span data-cover="/assets/shop/img/blog/1.jpeg" data-height="100%"></span>
              </a>
              <div class="media-body p-3">
                <a href="blog-single.html" class="h5 card-link mb-3 d-block">5 Coolest Winter Outfits You Can Steal</a>
                <p class="d-none d-sm-block text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ipsam consequuntur eligendi a aut fugit nam. <a href="blog-single.html">Read more...</a></p>
        ...
        <div class="card card-style1 mt-3">
          <div class="card-body p-0">
            <div class="media align-items-stretch">
              <a href="blog-single.html" class="img img-zoom-in w-25">
                <span data-cover="/assets/shop/img/blog/2.jpeg" data-height="100%"></span>
              </a>
              <div class="media-body p-3">
                <a href="blog-single.html" class="h5 card-link mb-3 d-block">How to Pick the Right Men's Shirt</a>
                <p class="d-none d-sm-block text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ipsam consequuntur eligendi a aut fugit nam. <a href="blog-single.html">Read more...</a></p>
                <div class="small text-muted d-flex align-items-center">
        ...
        <div class="card card-style1 mt-3">
          <div class="card-body p-0">
            <div class="media align-items-stretch">
              <a href="blog-single.html" class="img img-zoom-in w-25">
                <span data-cover="/assets/shop/img/blog/3.jpeg" data-height="100%"></span>
              </a>
              <div class="media-body p-3">
                <a href="blog-single.html" class="h5 card-link mb-3 d-block">5 Simple Outfits for Men</a>
                <p class="d-none d-sm-block text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ipsam consequuntur eligendi a aut fugit nam. <a href="blog-single.html">Read more...</a></p>
                <div class="small text-muted d-flex align-items-center">
        ...
        <div class="card card-style1 mt-3">
          <div class="card-body p-0">
            <div class="media align-items-stretch">
              <a href="blog-single.html" class="img img-zoom-in w-25">
                <span data-cover="/assets/shop/img/blog/4.jpeg" data-height="100%"></span>
              </a>
              <div class="media-body p-3">
                <a href="blog-single.html" class="h5 card-link mb-3 d-block">Business Casual Outfit Ideas</a>
                <p class="d-none d-sm-block text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ipsam consequuntur eligendi a aut fugit nam. <a href="blog-single.html">Read more...</a></p>
                <div class="small text-muted d-flex align-items-center">
          ...
          <ul class="menu" id="menu">
            ...
            <li>
              ...
              <ul>
                ...
                <li class="mm-active"><a href="blog-list.html">Post List</a></li>

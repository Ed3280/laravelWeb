    ...
    <div class="container-fluid">
      ...
      <nav class="nav nav-main nav-gap-x-1 nav-pills ml-3 d-none d-lg-flex">
        <div class="nav-item dropdown dropdown-hover">
          <a class="nav-link dropdown-toggle no-caret forwardable active" href="../../../index.php" id="homeDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            Home
          </a>
  ...
  <div class="container-fluid mt-3">
    <div class="d-grid grid-template-col-2 grid-template-col-lg-3 grid-gap-1 grid-gap-sm-3">
      ...
      <div class="swiper-container grid-column-start-1 grid-column-end-3 grid-row-start-1 grid-row-end-3" id="homeSlider">
        <div class="swiper-wrapper">
          <div class="swiper-slide" data-cover="/assets/shop/img/slider/1.jpg" data-height="220px 320px 350px 470px 420px">
          ...
          <div class="swiper-slide" data-cover="/assets/shop/img/slider/2.jpg" data-height="220px 320px 350px 470px 420px">
          ...
          <div class="swiper-slide" data-cover="/assets/shop/img/slider/3.jpg" data-height="220px 320px 350px 470px 420px">
            <div class="overlay-content overlay-show align-items-end text-white">
              <div class="text-center">
      ...
      <div class="card card-style1 overflow-hidden">
        <div class="d-grid grid-template-row-2 grid-template-row-md-none grid-template-col-md-2">
          <div data-cover="/assets/shop/img/categories/men.jpg" class="order-md-2"></div>
      ...
      <div class="card card-style1 overflow-hidden">
        <div class="d-grid grid-template-row-2 grid-template-row-md-none grid-template-col-md-2">
          <div data-cover="/assets/shop/img/categories/women.jpg" class="order-md-2"></div>
          <div class="text-center p-3 order-md-1">
            <h3>Women</h3>
            <p class="text-center d-none d-md-block">Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
    ...
    <div class="d-grid grid-template-col-2 grid-template-col-lg-4 grid-gap-1 grid-gap-sm-3 mt-3">
      <div class="img img-zoom-in">
        <div data-cover="/assets/shop/img/discover/2.jpeg" data-height="125px 130px 150px 120px 150px"></div>
        <div class="overlay overlay-show bg-dark"></div>
      ...
      <div class="img img-zoom-in">
        <div data-cover="/assets/shop/img/discover/3.jpeg" data-height="125px 130px 150px 120px 150px"></div>
        <div class="overlay overlay-show bg-dark"></div>
        <div class="overlay-content overlay-show">
      ...
      <div class="img img-zoom-in">
        <div data-cover="/assets/shop/img/discover/4.jpeg" data-height="125px 130px 150px 120px 150px"></div>
        <div class="overlay overlay-show bg-dark"></div>
        <div class="overlay-content overlay-show">
      ...
      <div class="img img-zoom-in">
        <div data-cover="/assets/shop/img/discover/5.jpeg" data-height="125px 130px 150px 120px 150px"></div>
        <div class="overlay overlay-show bg-dark"></div>
        <div class="overlay-content overlay-show">
          ...
          <div class="swiper-wrapper">
            <div class="swiper-slide card card-product">
              <div class="card-body">
                ...
                <a href="shop-single.html"><img class="card-img-top" src="/assets/shop/img/products/flash_deals_1.jpg" alt="Card image cap"></a>
            ...
            <div class="swiper-slide card card-product">
              <div class="card-body">
                <button class="btn btn-icon btn-text-danger rounded-circle btn-wishlist atw-demo" data-toggle="button" title="Add to wishlist"></button>
                <a href="shop-single.html"><img class="card-img-top" src="/assets/shop/img/products/flash_deals_2.jpg" alt="Card image cap"></a>
          ...
          <div class="swiper-wrapper pb-5">
            <div class="swiper-slide card p-3">
              <a href="shop-grid.html" class="stretched-link">
                <img src="/assets/shop/img/brands/brand1.svg" alt="brand1" class="card-img-top">
              </a>
            </div>
            <div class="swiper-slide card p-3">
              <a href="shop-grid.html" class="stretched-link">
                <img src="/assets/shop/img/brands/brand2.svg" alt="brand2" class="card-img-top">
              </a>
            </div>
            <div class="swiper-slide card p-3">
              <a href="shop-grid.html" class="stretched-link">
                <img src="/assets/shop/img/brands/brand3.svg" alt="brand3" class="card-img-top">
              </a>
            </div>
            <div class="swiper-slide card p-3">
              <a href="shop-grid.html" class="stretched-link">
                <img src="/assets/shop/img/brands/brand4.svg" alt="brand4" class="card-img-top">
              </a>
            </div>
            <div class="swiper-slide card p-3">
              <a href="shop-grid.html" class="stretched-link">
                <img src="/assets/shop/img/brands/brand5.svg" alt="brand5" class="card-img-top">
              </a>
            </div>
            <div class="swiper-slide card p-3">
              <a href="shop-grid.html" class="stretched-link">
        ...
        <div class="card-body">
          ...
          <ul class="list-group list-group-flush list-group-sms">
            <li class="list-group-item px-0">
              <div class="media">
                <a href="shop-single.html">
                  <img src="/assets/shop/img/products/1_small.jpg" width="75" alt="product">
                </a>
                <div class="media-body ml-3">
            ...
            <li class="list-group-item px-0">
              <div class="media">
                <a href="shop-single.html">
                  <img src="/assets/shop/img/products/2_small.jpg" width="75" alt="product">
                </a>
                <div class="media-body ml-3">
            ...
            <li class="list-group-item px-0">
              <div class="media">
                <a href="shop-single.html">
                  <img src="/assets/shop/img/products/3_small.jpg" width="75" alt="product">
                </a>
                <div class="media-body ml-3">
            ...
            <li class="list-group-item px-0">
              <div class="media">
                <a href="shop-single.html">
                  <img src="/assets/shop/img/products/4_small.jpg" width="75" alt="product">
                </a>
                <div class="media-body ml-3">

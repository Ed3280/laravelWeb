      ...
      <ul class="nav treeview mb-4" data-accordion>
        ...
        <li class="nav-item">
          ...
          <ul class="nav">
            ...
            <li class="nav-item"><a href="lists.html" class="nav-link active">List Group</a></li>
      ...
      <div class="row">
        <div class="col">
            ...
            <div class="card-body">
              <section id="section1">
                ...
                <p class="text-muted font-size-sm">
                  The most basic list group is an unordered list with list items and the proper classes.<br>
                  Build upon it with the options that follow, or with your own CSS as needed.
                </p>
                <ul class="list-group list-group-example">
          ...
          <div class="card mt-5">
            <div class="card-body">
              <section id="section2">
                <h5>Small List Group</h5>
                <p class="text-muted font-size-sm">
                  Add <code>.list-group-sm</code> to make list group more compact.
                </p>
          ...
          <div class="card mt-5">
            <div class="card-body">
              <section id="section3">
                ...
                <ul class="list-group list-group-flush list-group-example">
                  <li class="list-group-item"><strong>Retina: 13.3-inch </strong><span class="text-secondary">Display</span></li>
                  <li class="list-group-item"><strong>Intel Iris Graphics 6100 </strong><span class="text-secondary">Graphics</span></li>
                  <li class="list-group-item"><strong>500 GB Flash </strong><span class="text-secondary">Storage</span></li>
                  <li class="list-group-item"><strong>3.1 GHz Intel Core i7 </strong><span class="text-secondary">Processor</span></li>
          ...
          <div class="card mt-5">
            <div class="card-body">
              <section id="section4">
                <h5>Borderless List Group</h5>
                <p class="text-muted font-size-sm">
                  Add <code>.list-group-borderless</code> for a list-group without borders.
                </p>
                <ul class="list-group list-group-borderless list-group-example">
                  <li class="list-group-item"><strong>Retina: 13.3-inch </strong><span class="text-secondary">Display</span></li>
                  <li class="list-group-item"><strong>Intel Iris Graphics 6100 </strong><span class="text-secondary">Graphics</span></li>
                  <li class="list-group-item"><strong>500 GB Flash </strong><span class="text-secondary">Storage</span></li>
                  <li class="list-group-item"><strong>3.1 GHz Intel Core i7 </strong><span class="text-secondary">Processor</span></li>
          ...
          <div class="card mt-5">
            <div class="card-body">
              <section id="section5">
                <h5>Striped List Group</h5>
                <p class="text-muted font-size-sm">
                  Use <code>.list-group-striped</code> to add zebra-striping to any list-group.
                </p>
                <ul class="list-group list-group-striped list-group-example bg-white rounded">
                  <li class="list-group-item"><strong>Retina: 13.3-inch </strong><span class="text-secondary">Display</span></li>
                  <li class="list-group-item"><strong>Intel Iris Graphics 6100 </strong><span class="text-secondary">Graphics</span></li>
                  <li class="list-group-item"><strong>500 GB Flash </strong><span class="text-secondary">Storage</span></li>
                  <li class="list-group-item"><strong>3.1 GHz Intel Core i7 </strong><span class="text-secondary">Processor</span></li>
          ...
          <div class="card mt-5">
            <div class="card-body">
              <section id="section6">
                <h5>With Icon</h5>
                <p class="text-muted font-size-sm">
                  Add an icon to any list group item by adding <code>.has-icon</code>.
                </p>
                <ul class="list-group list-group-example">
                  <li class="list-group-item has-icon"><i data-feather="check-circle" class="text-success mr-2"></i><strong>Retina: 13.3-inch </strong><span class="text-secondary">Display</span></li>
                  <li class="list-group-item has-icon"><i data-feather="check-circle" class="text-success mr-2"></i><strong>Intel Iris Graphics 6100 </strong><span class="text-secondary">Graphics</span></li>
                  <li class="list-group-item has-icon"><i data-feather="check-circle" class="text-success mr-2"></i><strong>500 GB Flash </strong><span class="text-secondary">Storage</span></li>
                  <li class="list-group-item has-icon"><i data-feather="check-circle" class="text-success mr-2"></i><strong>3.1 GHz Intel Core i7 </strong><span class="text-secondary">Processor</span></li>
                  <li class="list-group-item has-icon"><i data-feather="check-circle" class="text-success mr-2"></i><strong>16 GB 1867 MHz DDR3 </strong><span class="text-secondary">Memory</span></li>
                </ul>
              </section>
            </div>
          </div>
              ...
              <section id="section7">
                ...
                <ul class="list-group list-group-example">
                  <li class="list-group-item d-flex align-items-center">
                    <div class="media">
                      <img src="/assets/admin/img/user1.svg" alt="user" class="rounded-circle" width="40">
                      <div class="media-body ml-2">
                  ...
                  <li class="list-group-item d-flex align-items-center">
                    <div class="media">
                      <img src="/assets/admin/img/user2.svg" alt="user" class="rounded-circle" width="40">
                      <div class="media-body ml-2">
                  ...
                  <li class="list-group-item d-flex align-items-center">
                    <div class="media">
                      <img src="/assets/admin/img/user3.svg" alt="user" class="rounded-circle" width="40">
                      <div class="media-body ml-2">
          ...
          <div class="card mt-5">
            <div class="card-body">
              <section id="section8">
                <h5>Horizontal List Group</h5>
                <p class="text-muted font-size-sm">
                  Add <code>.list-group-horizontal</code> to change the layout of list group items from vertical to horizontal across all breakpoints.<br>
                  Alternatively, choose a responsive variant <code>.list-group-horizontal-{sm|md|lg|xl}</code> to make a list group horizontal starting at that breakpoint’s min-width.
                </p>
                <ul class="list-group list-group-horizontal">
                  <li class="list-group-item">
                    <div class="text-secondary">Display</div><strong>Retina: 13.3-inch </strong>
                  </li>
                  <li class="list-group-item">
                    <div class="text-secondary">Graphics</div><strong>Intel Iris Graphics 6100 </strong>
                  </li>
                  <li class="list-group-item">
                    <div class="text-secondary">Storage</div><strong>500 GB Flash </strong>
                  </li>
                </ul>
                <p class="text-secondary font-size-sm mt-4 mb-0">
                  Want equal-width list group items when horizontal? Add <code>.flex-fill</code> to each list group item.
                </p>
                <ul class="list-group list-group-horizontal">
        ...
        <div class="col-3 d-none d-xl-block">
          <div class="nav-section">
            ...
            <nav id="navSection" class="nav flex-column">
              ...
              <a href="#section2" class="nav-link nav-link-sm">Small List Group</a>
              <a href="#section3" class="nav-link nav-link-sm">Flush</a>
              <a href="#section4" class="nav-link nav-link-sm">Borderless List Group</a>
              <a href="#section5" class="nav-link nav-link-sm">Striped List Group</a>
              <a href="#section6" class="nav-link nav-link-sm">With Icon</a>
              <a href="#section7" class="nav-link nav-link-sm">Custom Content</a>
              <a href="#section8" class="nav-link nav-link-sm">Horizontal List Group</a>
            </nav>
          </div>
        </div>
      </div>

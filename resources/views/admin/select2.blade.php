      ...
      <ul class="nav treeview mb-4" data-accordion>
        ...
        <li class="nav-item">
          ...
          <ul class="nav">
            ...
            <li class="nav-item"><a href="select2.html" class="nav-link active">Select2</a></li>
          ...
          <div class="card mt-5">
            <div class="card-body">
              <section id="section2">
                ...
                <p class="text-muted font-size-sm">
                  Select2 supports displaying a placeholder value using the <code>data-placeholder</code> attribute. The placeholder value will be displayed until a selection is made.
                </p>
                <div class="row">
                  <div class="col-sm-6">
          ...
          <div class="card mt-5">
            <div class="card-body">
              <section id="section3">
                ...
                <p class="text-muted font-size-sm">
                  Select2 support group related options with <code>&lt;optgroup&gt;</code> tags
                </p>
                <div class="row">
                  <div class="col-sm-6">
                    <select class="form-control select2">
          ...
          <div class="card mt-5">
            <div class="card-body">
              <section id="section4">
                ...
                <div class="row">
                  <div class="col-sm-6">
                    <select class="form-control select2" multiple data-placeholder="Choose browsers">
          ...
          <div class="card mt-5">
            <div class="card-body">
              <section id="section5">
                ...
                <p class="text-muted font-size-sm">
                  Limit the number of options that can be selected via the <code>data-maximum-selection-length</code> attribute.
                </p>
                <div class="row">
                  <div class="col-sm-6">
                    <select class="form-control select2" data-placeholder="Choose supported browsers" multiple data-maximum-selection-length="2">
                      <option value="1">Firefox</option>
                      <option value="2">Chrome</option>
                      <option value="4">Safari</option>
                      <option value="5">Opera</option>
          ...
          <div class="card mt-5">
            <div class="card-body">
              <section id="section6">
                <h5>Live search</h5>
                <p class="text-muted font-size-sm">
                  You can add a search input by passing <code>data-select2-search="true"</code> attribute.
                </p>
                <div class="row">
                  <div class="col-sm-6">
                    <select class="form-control select2" data-select2-search="true" data-placeholder="Choose browser">
                      <option></option>
                      <option value="1">Firefox</option>
                      <option value="2">Chrome</option>
                      <option value="4">Safari</option>
          ...
          <div class="card mt-5">
            <div class="card-body">
              <section id="section7">
                <h5>Creatable</h5>
                <p class="text-muted font-size-sm">
                  In addition to a prepopulated menu of options, Select2 can dynamically create new options from text input by the user in the search box. This feature is called "tagging". To enable tagging, set the <code>data-tags</code> attribute to <code>true</code>.
                </p>
                <div class="row">
                  <div class="col-sm-6 mb-1">
                    <select class="form-control select2" data-select2-search="true" data-placeholder="Find Microsoft's browser" data-tags="true">
                      <option></option>
                  ...
                  <div class="col-sm-6 mb-1">
                    <select class="form-control select2" multiple data-placeholder="Tags" data-tags="true">
          ...
          <div class="card mt-5">
            <div class="card-body">
              <section id="section8">
                ...
                <p class="text-muted font-size-sm">
                  To enable custom content, set the <code>data-select2-content</code> attribute to <code>true.</code><br />
                  Insert custom HTML into the option with the <code>data-content</code> attribute.
                </p>
                <div class="row">
                  <div class="col-sm-6">
                    <select class="form-control select2" data-select2-content="true">
                      <option value="1" data-content="<div class='d-flex align-items-center'><img src='/assets/admin/img/user1.svg' class='rounded-circle mr-2' width='30'> Socrates Itumay</div>">Socrates Itumay</option>
                      <option value="2" data-content="<div class='d-flex align-items-center'><img src='/assets/admin/img/user2.svg' class='rounded-circle mr-2' width='30'> Reynante Labares</div>">Reynante Labares</option>
                      <option value="3" data-content="<div class='d-flex align-items-center'><img src='/assets/admin/img/user3.svg' class='rounded-circle mr-2' width='30'> Marianne Audrey</div>">Marianne Audrey</option>
                    </select>
                  </div>
                </div>
              </section>
          ...
          <div class="card mt-5">
            <div class="card-body">
              <section id="section9">
                <h5>Sizing</h5>
                <p class="text-muted font-size-sm">
                  Set size with <code>data-select2-size</code> attribute.
                </p>
                <div class="row">
                  <div class="col-sm-6 mb-1">
                    <select class="form-control select2" data-select2-size="sm">
                      <option value="1">Firefox</option>
                      <option value="2">Chrome</option>
                      <option value="3">Safari</option>
                      <option value="4">Opera</option>
                  ...
                  <div class="col-sm-6 mb-1">
                    <select class="form-control select2" data-select2-size="sm" disabled>
                      <option value="1">Firefox</option>
                      <option value="2">Chrome</option>
                      <option value="3">Safari</option>
                      <option value="4">Opera</option>
                  ...
                  <div class="col-sm-6 mb-1">
                    <select class="form-control select2" data-select2-size="lg">
                      <option value="1">Firefox</option>
                      <option value="2">Chrome</option>
                      <option value="3">Safari</option>
                      <option value="4">Opera</option>
                  ...
                  <div class="col-sm-6 mb-1">
                    <select class="form-control select2" data-select2-size="lg" disabled>
                      <option value="1">Firefox</option>
                      <option value="2">Chrome</option>
                      <option value="3">Safari</option>
                      <option value="4">Opera</option>
          ...
          <div class="card mt-5">
            <div class="card-body">
              <section id="section10">
                ...
                <div class="row">
                  <div class="col-sm-6 mb-1">
                    <select class="form-control select2" data-placeholder="Choose browser" data-allow-clear="true">
                      <option></option>
                      <option value="1">Firefox</option>
                      <option value="2">Chrome</option>
                      <option value="4">Safari</option>
        ...
        <div class="col-3 d-none d-xl-block">
          <div class="nav-section">
            ...
            <nav id="navSection" class="nav flex-column">
              ...
              <a href="#section4" class="nav-link nav-link-sm">Multiple select boxes</a>
              <a href="#section5" class="nav-link nav-link-sm">Limit selection</a>
              <a href="#section6" class="nav-link nav-link-sm">Live search</a>
              <a href="#section7" class="nav-link nav-link-sm">Creatable</a>
              <a href="#section8" class="nav-link nav-link-sm">Custom content</a>
              <a href="#section9" class="nav-link nav-link-sm">Sizing</a>
              <a href="#section10" class="nav-link nav-link-sm">Clearable</a>
            </nav>
          </div>
        </div>
      </div>

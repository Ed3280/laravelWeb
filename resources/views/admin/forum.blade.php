  ...
  <div class="sidebar">
    ...
    <div class="sidebar-body">
      <ul class="nav treeview mb-4" data-accordion>
        ...
        <li class="nav-item">
          <a class="nav-link has-icon active" href="forum.html"><i class="far fa-comments"></i>Forum</a>
        </li>
        <li class="nav-item">
          ...
          <div class="inner-sidebar-body p-0">
            <div class="p-3 h-100" data-simplebar>
              <nav class="nav nav-pills nav-gap-y-1 flex-column">
                <a href="javascript:void(0)" class="nav-link nav-link-faded has-icon active"><i class="material-icons mr-2">chat</i>All Threads</a>
                <a href="javascript:void(0)" class="nav-link nav-link-faded has-icon"><i class="material-icons mr-2">stars</i>Popular this week</a>
                <a href="javascript:void(0)" class="nav-link nav-link-faded has-icon"><i class="material-icons mr-2">stars</i>Popular all time</a>
                <a href="javascript:void(0)" class="nav-link nav-link-faded has-icon"><i class="material-icons mr-2">check_circle_outline</i>Solved</a>
                <a href="javascript:void(0)" class="nav-link nav-link-faded has-icon"><i class="material-icons mr-2">highlight_off</i>Unsolved</a>
                <a href="javascript:void(0)" class="nav-link nav-link-faded has-icon"><i class="material-icons mr-2">reply</i>No replies yet</a>
              </nav>
            </div>
          </div>
          <!-- /Inner sidebar body -->
        ...
        <div class="inner-main">
          ...
          <div class="inner-main-body p-2 p-sm-3 collapse forum-content show">
            <div class="card mb-2">
              <div class="card-body p-2 p-sm-3">
                <div class="media forum-item">
                  <a href="#" data-toggle="collapse" data-target=".forum-content"><img src="/assets/admin/img/user1.svg" class="mr-3 rounded-circle" width="50" alt="User"></a>
                  <div class="media-body">
                    ...
                    <p class="text-muted">
                      <a href="javascript:void(0)">drewdan</a> replied <span class="text-secondary font-weight-bold">13 minutes ago</span>
                    </p>
                  </div>
            ...
            <div class="card mb-2">
              <div class="card-body p-2 p-sm-3">
                <div class="media forum-item">
                  <a href="#" data-toggle="collapse" data-target=".forum-content"><img src="/assets/admin/img/user2.svg" class="mr-3 rounded-circle" width="50" alt="User"></a>
                  <div class="media-body">
                    ...
                    <p class="text-muted">
                      <a href="javascript:void(0)">jlrdw</a> replied <span class="text-secondary font-weight-bold">3 hours ago</span>
                    </p>
                  </div>
                  <div class="text-muted small text-center align-self-center">
            ...
            <div class="card mb-2">
              <div class="card-body p-2 p-sm-3">
                <div class="media forum-item">
                  <a href="#" data-toggle="collapse" data-target=".forum-content"><img src="/assets/admin/img/user3.svg" class="mr-3 rounded-circle" width="50" alt="User"></a>
                  <div class="media-body">
                    ...
                    <p class="text-muted">
                      <a href="javascript:void(0)">ciungulete</a> replied <span class="text-secondary font-weight-bold">7 hours ago</span>
                    </p>
                  </div>
                  <div class="text-muted small text-center align-self-center">
            ...
            <div class="card mb-2">
              <div class="card-body p-2 p-sm-3">
                <div class="media forum-item">
                  <a href="#" data-toggle="collapse" data-target=".forum-content"><img src="/assets/admin/img/user4.svg" class="mr-3 rounded-circle" width="50" alt="User"></a>
                  <div class="media-body">
                    ...
                    <p class="text-muted">
                      <a href="javascript:void(0)">bugsysha</a> replied <span class="text-secondary font-weight-bold">11 hours ago</span>
                    </p>
                  </div>
                  <div class="text-muted small text-center align-self-center">
            ...
            <div class="card mb-2">
              <div class="card-body p-2 p-sm-3">
                <div class="media forum-item">
                  <a href="#" data-toggle="collapse" data-target=".forum-content"><img src="/assets/admin/img/user5.svg" class="mr-3 rounded-circle" width="50" alt="User"></a>
                  <div class="media-body">
                    ...
                    <p class="text-muted">
                      <a href="javascript:void(0)">jackalds</a> replied <span class="text-secondary font-weight-bold">12 hours ago</span>
                    </p>
                  </div>
                  <div class="text-muted small text-center align-self-center">
            ...
            <div class="card mb-2">
              <div class="card-body p-2 p-sm-3">
                <div class="media forum-item">
                  <a href="#" data-toggle="collapse" data-target=".forum-content"><img src="/assets/admin/img/user.svg" class="mr-3 rounded-circle" width="50" alt="User"></a>
                  <div class="media-body">
                    ...
                    <p class="text-muted">
                      <a href="javascript:void(0)">bugsysha</a> replied <span class="text-secondary font-weight-bold">14 hours ago</span>
                    </p>
                  </div>
                  <div class="text-muted small text-center align-self-center">
              ...
              <div class="card-body p-2 p-sm-3">
                <div class="media forum-item">
                  ...
                  <div class="media-body">
                    ...
                    <p class="text-muted">
                      <a href="javascript:void(0)">michaeloravec</a> replied <span class="text-secondary font-weight-bold">18 hours ago</span>
                    </p>
                  </div>
                  <div class="text-muted small text-center align-self-center">
          ...
          <div class="inner-main-body p-2 p-sm-3 collapse forum-content">
              ...
              <div class="card-body">
                <div class="media forum-item">
                  <a href="javascript:void(0)" class="card-link">
                    <img src="/assets/admin/img/user1.svg" class="rounded-circle" width="50" alt="User">
            ...
            <div class="card mb-2">
              <div class="card-body">
                <div class="media forum-item">
                  <a href="javascript:void(0)" class="card-link">
                    <img src="/assets/admin/img/user2.svg" class="rounded-circle" width="50" alt="User">

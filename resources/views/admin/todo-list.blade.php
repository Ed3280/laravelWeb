  ...
  <div class="sidebar">
    ...
    <div class="sidebar-body">
      <ul class="nav treeview mb-4" data-accordion>
        ...
        <li class="nav-item">
          <a class="nav-link has-icon active" href="todo-list.html"><i data-feather="check-square"></i>Todo List</a>
        </li>
        <li class="nav-item">
      ...
      <div class="inner-wrapper">
        ...
        <div class="inner-sidebar">
          ...
          <div class="inner-sidebar-header justify-content-center">
            <button class="btn btn-warning has-icon btn-block" type="button" data-toggle="modal" data-target="#taskModal">
              <i data-feather="plus" class="mr-2"></i> New Task
            </button>
          </div>
          <!-- /Inner sidebar header -->
          ...
          <div class="inner-sidebar-body p-0">
            <div class="p-3 h-100" data-simplebar>
              <nav class="nav nav-pills nav-gap-y-1 flex-column">
                <a href="javascript:void(0)" class="nav-link nav-link-faded has-icon active"><i class="material-icons mr-2">list</i>All<span class="badge badge-pill badge-primary ml-auto">8</span></a>
                <a href="javascript:void(0)" class="nav-link nav-link-faded has-icon"><i class="material-icons mr-2">check_circle_outline</i>Done<span class="badge badge-pill badge-secondary ml-auto">2</span></a>
                <a href="javascript:void(0)" class="nav-link nav-link-faded has-icon"><i class="material-icons mr-2">stars</i>Important<span class="badge badge-pill badge-secondary ml-auto">3</span></a>
                <a href="javascript:void(0)" class="nav-link nav-link-faded has-icon"><i class="material-icons mr-2">archive</i>Archive</a>
                <a href="javascript:void(0)" class="nav-link nav-link-faded has-icon"><i class="material-icons mr-2">delete</i>Trash</a>
              </nav>
            </div>
          </div>
          <!-- /Inner sidebar body -->
        ...
        <div class="inner-main">
          ...
          <div class="inner-main-header">
            ...
            <h5 class="mb-0">All todo lists</h5>
          </div>
          <!-- /Inner main header -->

          <!-- Inner main body -->
          <div class="inner-main-body p-0">
            <ul class="list-group list-group-flush">
              <li class="list-group-item has-icon">
                <div class="media todo-item">
                  <div class="custom-color custom-color-lg">
                    <div class="color-item">
                      <input type="checkbox" name="item1" value="primary" id="item1" class="custom-control-input" data-toggle="todo-item">
                      <label class="rounded-circle" for="item1"></label>
                    </div>
                  </div>
                  <div class="media-body ml-3">
                    <h6>Carry Out Risk Assessment</h6>
                    <p class="small text-secondary mb-0">Lorem ipsum dolor sit amet consectetur adipisicing elit. Iure minus autem impedit odit aspernatur perspiciatis.</p>
                  </div>
                  ...
                  <div class="dropdown" hidden>
                    <button class="btn btn-icon dropdown-toggle btn-sm" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-display="static"></button>
                  ...
                  <time class="text-muted small">Aug, 08 2019</time>
                </div>
              </li>
              <li class="list-group-item has-icon">
                <div class="media todo-item">
                  <div class="custom-color custom-color-lg">
                    <div class="color-item">
                      <input type="checkbox" name="item2" value="primary" id="item2" class="custom-control-input" data-toggle="todo-item">
                      <label class="rounded-circle" for="item2"></label>
                    </div>
                  </div>
                  <div class="media-body ml-3">
                    <h6>Assignment of Tasks</h6>
                    <p class="small text-secondary mb-0">Lorem ipsum dolor sit amet consectetur adipisicing elit. Iure minus autem impedit odit aspernatur perspiciatis.</p>
                  </div>
                  <div class="btn-group btn-group-xs" role="group">
                    <a href="javascript:void(0)" class="btn btn-link btn-icon bigger-130 text-success"><i data-feather="edit"></i></a>
                  ...
                  <time class="text-muted small">Aug, 07 2019</time>
                </div>
              </li>
              <li class="list-group-item has-icon">
                <div class="media todo-item">
                  <div class="custom-color custom-color-lg">
                    <div class="color-item">
                      <input type="checkbox" name="item3" value="primary" id="item3" class="custom-control-input" data-toggle="todo-item">
                      <label class="rounded-circle" for="item3"></label>
                    </div>
                  </div>
                  <div class="media-body ml-3">
                    <h6><i class="fa fa-star"></i> Create Project Schedule and Milestones</h6>
                    <p class="small text-secondary mb-0">Lorem ipsum dolor sit amet consectetur adipisicing elit. Iure minus autem impedit odit aspernatur perspiciatis.</p>
                  </div>
                  <div class="btn-group btn-group-xs" role="group">
                    <a href="javascript:void(0)" class="btn btn-link btn-icon bigger-130 text-success"><i data-feather="edit"></i></a>
                  ...
                  <time class="text-muted small">Aug, 06 2019</time>
                </div>
              </li>
              <li class="list-group-item has-icon">
                <div class="media todo-item">
                  <div class="custom-color custom-color-lg">
                    <div class="color-item">
                      <input type="checkbox" name="item4" value="primary" id="item4" class="custom-control-input" data-toggle="todo-item">
                      <label class="rounded-circle" for="item4"></label>
                    </div>
                  </div>
                  <div class="media-body ml-3">
                    <h6>Determine Deliverables</h6>
                    <p class="small text-secondary mb-0">Lorem ipsum dolor sit amet consectetur adipisicing elit. Iure minus autem impedit odit aspernatur perspiciatis.</p>
                  </div>
                  <div class="btn-group btn-group-xs" role="group">
                    <a href="javascript:void(0)" class="btn btn-link btn-icon bigger-130 text-success"><i data-feather="edit"></i></a>
                  ...
                  <time class="text-muted small">Aug, 05 2019</time>
                </div>
              </li>
              <li class="list-group-item has-icon">
                <div class="media todo-item">
                  <div class="custom-color custom-color-lg">
                    <div class="color-item">
                      <input type="checkbox" name="item5" value="primary" id="item5" class="custom-control-input" data-toggle="todo-item">
                      <label class="rounded-circle" for="item5"></label>
                    </div>
                  </div>
                  <div class="media-body ml-3">
                    <h6><i class="fa fa-star"></i> Set Goals and Objectives</h6>
                    <p class="small text-secondary mb-0">Lorem ipsum dolor sit amet consectetur adipisicing elit. Iure minus autem impedit odit aspernatur perspiciatis.</p>
                  </div>
                  <div class="btn-group btn-group-xs" role="group">
                    <a href="javascript:void(0)" class="btn btn-link btn-icon bigger-130 text-success"><i data-feather="edit"></i></a>
                  ...
                  <time class="text-muted small">Aug, 04 2019</time>
                </div>
              </li>
              <li class="list-group-item has-icon">
                <div class="media todo-item">
                  <div class="custom-color custom-color-lg">
                    <div class="color-item">
                      <input type="checkbox" name="item6" value="primary" id="item6" class="custom-control-input" data-toggle="todo-item">
                      <label class="rounded-circle" for="item6"></label>
                    </div>
                  </div>
                  <div class="media-body ml-3">
                    <h6>Define Project Scope</h6>
                    <p class="small text-secondary mb-0">Lorem ipsum dolor sit amet consectetur adipisicing elit. Iure minus autem impedit odit aspernatur perspiciatis.</p>
                  </div>
                  <div class="btn-group btn-group-xs" role="group">
                    <a href="javascript:void(0)" class="btn btn-link btn-icon bigger-130 text-success"><i data-feather="edit"></i></a>
                  ...
                  <time class="text-muted small">Aug, 03 2019</time>
                </div>
              </li>
              <li class="list-group-item has-icon">
                <div class="media todo-item done">
                  <div class="custom-color custom-color-lg">
                    <div class="color-item">
                      <input type="checkbox" name="item7" value="primary" id="item7" class="custom-control-input" data-toggle="todo-item" checked>
                      <label class="rounded-circle" for="item7"></label>
                    </div>
                  </div>
                  <div class="media-body ml-3">
                    <h6>Identify and Meet Stakeholders for Approval</h6>
                    <p class="small text-secondary mb-0">Lorem ipsum dolor sit amet consectetur adipisicing elit. Iure minus autem impedit odit aspernatur perspiciatis.</p>
                  </div>
                  <div class="btn-group btn-group-xs" role="group">
                    <a href="javascript:void(0)" class="btn btn-link btn-icon bigger-130 text-success"><i data-feather="edit"></i></a>
                  ...
                  <time class="text-muted small">Aug, 02 2019</time>
                </div>
              </li>
              <li class="list-group-item has-icon">
                <div class="media todo-item done">
                  <div class="custom-color custom-color-lg">
                    <div class="color-item">
                      <input type="checkbox" name="item8" value="primary" id="item8" class="custom-control-input" data-toggle="todo-item" checked>
                      <label class="rounded-circle" for="item8"></label>
                    </div>
                  </div>
                  <div class="media-body ml-3">
                    <h6><i class="fa fa-star"></i> Create and Analyze Business Case</h6>
                    <p class="small text-secondary mb-0">Lorem ipsum dolor sit amet consectetur adipisicing elit. Iure minus autem impedit odit aspernatur perspiciatis.</p>
                  </div>
                  <div class="btn-group btn-group-xs" role="group">
                    <a href="javascript:void(0)" class="btn btn-link btn-icon bigger-130 text-success"><i data-feather="edit"></i></a>
                  ...
                  <time class="text-muted small">Aug, 01 2019</time>
                </div>
              </li>
            </ul>
          </div>
          ...
          <div class="modal-content">
            <form>
              <div class="modal-header d-flex align-items-center">
                <h6 class="modal-title mb-0" id="taskModalLabel">New Task</h6>
              ...
              <div class="modal-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="taskTitle" placeholder="Enter task title" autofocus>
                </div>
                <div class="form-group">
                  <label for="taskDesc">Description</label>
                  <textarea class="form-control autosize" id="taskDesc" placeholder="Enter task description"></textarea>
                </div>
                <div class="custom-control custom-checkbox">
                  <input type="checkbox" class="custom-control-input" id="taskImportant">
                  <label class="custom-control-label" for="taskImportant">Important</label>
                </div>
              </div>

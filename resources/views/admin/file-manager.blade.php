    ...
    <div class="sidebar-body">
      <ul class="nav treeview mb-4" data-accordion>
        ...
        <li class="nav-item">
          ...
          <ul class="nav">
            <li class="nav-item"><a href="file-manager.html" class="nav-link active">File Manager v1</a></li>
      ...
      <div class="inner-wrapper">
        ...
        <div class="inner-sidebar">
          ...
          <div class="inner-sidebar-header">
            <div class="dropdown flex-fill">
              <button class="btn btn-light btn-sm btn-block bg-white dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                New
              </button>
              <div class="dropdown-menu font-size-sm">
                <button class="dropdown-item has-icon" type="button"><i class="mr-2" data-feather="folder"></i>Folder</button>
                <button class="dropdown-item has-icon" type="button"><i class="mr-2" data-feather="file-text"></i>Notes</button>
                <div class="dropdown-divider"></div>
                <button class="dropdown-item has-icon" type="button"><i class="far fa-file-word fa-fw mr-2"></i>Word Document</button>
                <button class="dropdown-item has-icon" type="button"><i class="far fa-file-powerpoint fa-fw mr-2"></i>Powerpoint</button>
                <button class="dropdown-item has-icon" type="button"><i class="far fa-file-excel fa-fw mr-2"></i>Excel Spreadsheet</button>
              </div>
            </div>
            <div class="dropdown flex-fill ml-2">
              ...
              <div class="dropdown-menu font-size-sm">
                <button class="dropdown-item has-icon" type="button"><i class="mr-2" data-feather="file"></i>File</button>
                <button class="dropdown-item has-icon" type="button"><i class="mr-2" data-feather="folder"></i>Folder</button>
              </div>
            </div>
          </div>
          ...
          <div class="inner-sidebar-body p-0">
            <div class="p-3 h-100" data-simplebar>
              <label class="small text-secondary">MY DRIVE</label>
              <nav class="nav nav-pills nav-gap-y-1 flex-column">
                <a href="javascript:void(0)" class="nav-link nav-link-faded has-icon active"><i class="material-icons mr-2">folder_open</i>All Files</a>
                <a href="javascript:void(0)" class="nav-link nav-link-faded has-icon"><i class="material-icons mr-2">desktop_mac</i>My Devices</a>
                <a href="javascript:void(0)" class="nav-link nav-link-faded has-icon"><i class="material-icons mr-2">access_time</i>Recents</a>
                <a href="javascript:void(0)" class="nav-link nav-link-faded has-icon"><i class="material-icons mr-2">star_border</i>Important</a>
                <a href="javascript:void(0)" class="nav-link nav-link-faded has-icon"><i class="material-icons mr-2">delete_outline</i>Deleted Files</a>
              </nav>
              <label class="small text-secondary mt-3">FILE LIBRARY</label>
              <nav class="nav nav-pills nav-gap-y-1 flex-column">
                <a href="javascript:void(0)" class="nav-link nav-link-faded has-icon"><i class="fa-fw far mr-2 fa-sticky-note"></i>Documents</a>
                <a href="javascript:void(0)" class="nav-link nav-link-faded has-icon"><i class="fa-fw fa mr-2 fa-camera"></i>Images</a>
                <a href="javascript:void(0)" class="nav-link nav-link-faded has-icon"><i class="fa-fw far mr-2 fa-play-circle"></i>Videos</a>
                <a href="javascript:void(0)" class="nav-link nav-link-faded has-icon"><i class="fa-fw fa mr-2 fa-music"></i>Audio</a>
                <a href="javascript:void(0)" class="nav-link nav-link-faded has-icon"><i class="fa-fw far mr-2 fa-file-archive"></i>Zip Files</a>
              </nav>
              <label class="small text-secondary mt-3">STORAGE STATUS</label>
              <div class="media my-3">
                <h2 class="mb-0"><i class="icon-inline" data-feather="database"></i></h2>
                <div class="media-body ml-3">
                  <small class="text-secondary">12.5GB used of 50GB</small>
                  <div class="progress" style="height: 3px">
                    <div class="progress-bar bg-success" role="progressbar" style="width: 25%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                  </div>
                </div>
              </div>
              <p class="small text-secondary">Get 2TB (2,000GB) of storage now and get 40% off. Offers ends soon. <a href="javascript:void(0)">Learn more</a></p>
            </div>
          </div>
          <!-- /Filemanager sidebar body -->
        ...
        <div class="inner-main">
          ...
          <div class="inner-main-body">
            <label class="small text-secondary">Recently Accessed Files</label>
            <div class="row row-cols-2 row-cols-sm-3 row-cols-xl-4 gutters-sm">
              <div class="col mb-3">
                <div class="card">
                  <div class="card-body">
                    <div href="javascript:void(0)" class="filemgr-thumb text-danger">
                      <i class="far fa-file-pdf"></i>
                    </div>
                    <a href="javascript:void(0)" class="stretched-link card-title card-link text-body font-size-sm d-block">Medical Certificate.pdf</a>
                    <small class="text-muted">10.45kb</small>
                  </div>
                  <div class="card-footer border-top-0 small text-muted">2 hours ago</div>
                </div>
              </div>
              <div class="col mb-3">
                <div class="card">
                  <div class="card-body">
                    <div href="javascript:void(0)" class="filemgr-thumb text-primary">
                      <i class="far fa-file-word"></i>
                    </div>
                    <a href="javascript:void(0)" class="stretched-link card-title card-link text-body font-size-sm d-block">Job Contract.docx</a>
                    <small class="text-muted">22.67kb</small>
                  </div>
                  <div class="card-footer border-top-0 small text-muted">5 hours ago</div>
                </div>
              </div>
              <div class="col mb-3">
                <div class="card">
                  <div class="card-body">
                    <div href="javascript:void(0)" class="filemgr-thumb text-success">
                      <i class="far fa-file-image"></i>
                    </div>
                    <a href="javascript:void(0)" class="stretched-link card-title card-link text-body font-size-sm d-block">IMG_063037.jpg</a>
                    <small class="text-muted">4.1mb</small>
                  </div>
                  <div class="card-footer border-top-0 small text-muted">6 hours ago</div>
                </div>
              </div>
              <div class="col mb-3">
                <div class="card">
                  <div class="card-body">
                    <div href="javascript:void(0)" class="filemgr-thumb text-info">
                      <i class="far fa-file-audio"></i>
                    </div>
                    <a href="javascript:void(0)" class="stretched-link card-title card-link text-body font-size-sm d-block">Music_One.mp3</a>
                    <small class="text-muted">3.40mb</small>
                  </div>
                  <div class="card-footer border-top-0 small text-muted">6 hours ago</div>
                </div>
              </div>
            </div>
            <label class="small text-secondary mt-4">Folders</label>
            <div class="row row-cols-2 row-cols-sm-3 row-cols-xl-4 gutters-sm">
              <div class="col mb-3">
                <div class="card p-1">
                  <div class="media align-items-center">
                    <h1 class="mb-0"><i class="icon-inline" data-feather="folder"></i></h1>
                    <div class="media-body ml-1">
                      <h6 class="mb-0">
                        <a href="javascript:void(0)" class="stretched-link text-body font-size-sm">
                          Downloads
                        </a>
                      </h6>
                      <small class="text-muted float-left">22 files, 1.04GB</small>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="card p-1">
                  <div class="media align-items-center">
                    ...
                    <div class="media-body ml-1">
                      ...
                      <small class="text-muted float-left">553 files, 14GB</small>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="card p-1">
                  <div class="media align-items-center">
                    ...
                    <div class="media-body ml-1">
                      ...
                      <small class="text-muted float-left">9 files, 734MB</small>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="card p-1">
                  <div class="media align-items-center">
                    ...
                    <div class="media-body ml-1">
                      ...
                      <small class="text-muted float-left">357 files, 159MB</small>
                    </div>
                  </div>
                </div>
              </div>
            </div>
            <label class="small text-secondary mt-4">Files</label>
            <div class="row row-cols-2 row-cols-sm-3 row-cols-xl-4 gutters-sm">
              <div class="col mb-3">
                <div class="card">
                  <div class="card-body">
                    ...
                    <a href="javascript:void(0)" class="stretched-link card-title card-link text-body font-size-sm d-block">Job Requirements.docx</a>
                    <small class="text-muted">10.45KB</small>
                  </div>
                </div>
              </div>
              <div class="col mb-3">
                <div class="card">
                  <div class="card-body">
                    <div href="javascript:void(0)" class="filemgr-thumb text-warning">
                      <i class="far fa-file-powerpoint"></i>
                    </div>
                    <a href="javascript:void(0)" class="stretched-link card-title card-link text-body font-size-sm d-block">My Presentation.ppt</a>
                    <small class="text-muted">135KB</small>
                  </div>
                </div>
              </div>
              <div class="col mb-3">
                <div class="card">
                  <div class="card-body">
                    ...
                    <a href="javascript:void(0)" class="stretched-link card-title card-link text-body font-size-sm d-block">Inventory.xls</a>
                    <small class="text-muted">22.67KB</small>
                  </div>
                </div>
              </div>
              <div class="col mb-3">
                <div class="card">
                  <div class="card-body">
                    ...
                    <a href="javascript:void(0)" class="stretched-link card-title card-link text-body font-size-sm d-block">GettingStarted.pdf</a>
                    <small class="text-muted">94KB</small>
                  </div>
                </div>
              </div>
            </div>

...
<head>
  ...
  <!-- Plugins -->
  <link rel="stylesheet" href="/assets/admin/plugins/photoswipe/photoswipe.min.css">
  <link rel="stylesheet" href="/assets/admin/plugins/photoswipe/photoswipe-default-skin/default-skin.min.css">
  <link rel="stylesheet" href="/assets/admin/plugins/imagecompare/imagecompare.min.css">
  <!-- Main Style -->
...
<body>
  ...
  <div class="sidebar">
    ...
    <div class="sidebar-body">
      <ul class="nav treeview mb-4" data-accordion>
        ...
        <li class="nav-item">
          <a class="nav-link has-icon active" href="images.html"><i data-feather="image"></i>Images</a>
        </li>
        <li class="nav-item">
        ...
        <div class="col">
          <section id="section1">
            ...
            <div style="max-width: 500px">
              <img src="/assets/admin/img/gallery/4.jpeg" class="img-fluid" alt="Responsive image">
            </div>
          </section>
          ...
          <section id="section2" class="mt-5">
            ...
            <img src="/assets/admin/img/gallery/4.jpeg" class="img-thumbnail" alt="Responsive image" width="200">
          </section>
          ...
          <section id="section3" class="mt-5">
            ...
            <div class="img">
              <img src="/assets/admin/img/user1.svg" alt="User" class="rounded-circle" width="50">
            </div>
            <div class="img online">
              <img src="/assets/admin/img/user2.svg" alt="User" class="rounded-circle" width="50">
            </div>
            <div class="img offline">
              <img src="/assets/admin/img/user3.svg" alt="User" class="rounded-circle" width="50">
            </div>
          </section>
          ...
          <section id="section4" class="mt-5">
            ...
            <div class="card text-white border-0" style="max-width: 400px" data-cover="/assets/admin/img/gallery/4.jpeg">
              <div class="card-body">
          ...
          <section id="section5" class="mt-5">
            ...
            <div class="img rounded">
              <img src="/assets/admin/img/gallery/3s.jpeg" alt="Image">
            ...
            <div class="img rounded">
              ...
              <div class="overlay-content text-center justify-content-end">
                <div class="btn-group mb-1" role="group">
                  <button type="button" class="btn btn-link btn-icon text-light"><i class="material-icons">zoom_in</i></button>
                  <button type="button" class="btn btn-link btn-icon text-light"><i class="material-icons">edit</i></button>
                  <button type="button" class="btn btn-link btn-icon text-danger"><i class="material-icons">delete</i></button>
                </div>
              </div>
            </div>
            <div class="img rounded">
          ...
          <section id="section6" class="mt-5">
            ...
            <div class="list-with-gap" id="example-gallery">
              <div class="img rounded">
                <img src="/assets/admin/img/gallery/1s.jpeg" alt="Image" width="150">
                <div class="overlay bg-dark"></div>
                <div class="overlay-content text-center justify-content-end">
                  <div class="btn-group btn-group-sm mb-1" role="group">
                    <button data-index="1" data-size="1280x853" data-target="../../../dist/img/gallery/1.jpeg" type="button" class="open-ps btn btn-link btn-icon text-light">
              ...
              <div class="img rounded">
                <img src="/assets/admin/img/gallery/2s.jpeg" alt="Image" width="150">
                <div class="overlay bg-dark"></div>
                <div class="overlay-content text-center justify-content-end">
                  <div class="btn-group btn-group-sm mb-1" role="group">
                    <button data-index="2" data-size="1280x853" data-target="../../../dist/img/gallery/2.jpeg" type="button" class="open-ps btn btn-link btn-icon text-light">
                      <i class="material-icons">zoom_in</i>
                    </button>
                    <button type="button" class="btn btn-link btn-icon text-light"><i class="material-icons">edit</i></button>
                    <button type="button" class="btn btn-link btn-icon text-danger"><i class="material-icons">delete</i></button>
              ...
              <div class="img rounded">
                <img src="/assets/admin/img/gallery/3s.jpeg" alt="Image" width="150">
                <div class="overlay bg-dark"></div>
                <div class="overlay-content text-center justify-content-end">
                  <div class="btn-group btn-group-sm mb-1" role="group">
                    <button data-index="3" data-size="1280x853" data-target="../../../dist/img/gallery/3.jpeg" type="button" class="open-ps btn btn-link btn-icon text-light">
                      <i class="material-icons">zoom_in</i>
                    </button>
                    <button type="button" class="btn btn-link btn-icon text-light"><i class="material-icons">edit</i></button>
                    <button type="button" class="btn btn-link btn-icon text-danger"><i class="material-icons">delete</i></button>
              ...
              <div class="img rounded">
                <img src="/assets/admin/img/gallery/4s.jpeg" alt="Image" width="150">
                <div class="overlay bg-dark"></div>
                <div class="overlay-content text-center justify-content-end">
                  <div class="btn-group btn-group-sm mb-1" role="group">
                    <button data-index="4" data-size="1280x853" data-target="../../../dist/img/gallery/4.jpeg" type="button" class="open-ps btn btn-link btn-icon text-light">
                      <i class="material-icons">zoom_in</i>
                    </button>
                    <button type="button" class="btn btn-link btn-icon text-light"><i class="material-icons">edit</i></button>
                    <button type="button" class="btn btn-link btn-icon text-danger"><i class="material-icons">delete</i></button>
              ...
              <div class="img rounded">
                <img src="/assets/admin/img/gallery/5s.jpeg" alt="Image" width="150">
                <div class="overlay bg-dark"></div>
                <div class="overlay-content text-center justify-content-end">
                  <div class="btn-group btn-group-sm mb-1" role="group">
                    <button data-index="5" data-size="1280x853" data-target="../../../dist/img/gallery/5.jpeg" type="button" class="open-ps btn btn-link btn-icon text-light">
                      <i class="material-icons">zoom_in</i>
                    </button>
                    <button type="button" class="btn btn-link btn-icon text-light"><i class="material-icons">edit</i></button>
                    <button type="button" class="btn btn-link btn-icon text-danger"><i class="material-icons">delete</i></button>
          ...
          <section id="section7" class="mt-5">
            ...
            <p class="text-secondary font-size-sm">
              Simple responsive Image comparison
            </p>
            <div class="imagecompare" id="exampleCompare">
              <img src="/assets/admin/img/compare1.png">
              <div class="comparator">
                <img src="/assets/admin/img/compare2.png">
              </div>
        ...
        <div class="col-3 d-none d-xl-block">
          <div class="nav-section">
            ...
            <nav id="navSection" class="nav flex-column">
              ...
              <a href="#section7" class="nav-link nav-link-sm">Image comparison</a>
            </nav>
          </div>
        </div>
      </div>
  ...
  <!-- Plugins -->
  <script src="/assets/admin/plugins/photoswipe/photoswipe.min.js"></script>
  <script src="/assets/admin/plugins/photoswipe/photoswipe-ui-default.min.js"></script>
  <script src="/assets/admin/plugins/imagecompare/imagecompare.min.js"></script>
  <script>

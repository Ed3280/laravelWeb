...
<head>
  ...
  <!-- Plugins -->
  <link rel="stylesheet" href="/assets/admin/plugins/swiper/swiper.min.css">
  <!-- Main Style -->
...
<body>
      ...
      <ul class="nav treeview mb-4" data-accordion>
        ...
        <li class="nav-item">
          ...
          <ul class="nav">
            ...
            <li class="nav-item"><a href="carousel.html" class="nav-link active">Carousel</a></li>
  ...
  <div class="main">
    ...
    <div class="main-body">
      ...
      <div class="row gutters-sm">
        <div class="col-md-4 mb-3">
          <div class="card card-body">
            <h6 class="text-center">Basic</h6>
            <div id="carouselSlidesOnly" class="carousel slide" data-ride="carousel" data-interval="2500" data-pause="false">
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img src="/assets/admin/img/gallery/1.jpeg" class="d-block w-100" alt="Slide 1">
                </div>
                <div class="carousel-item">
                  <img src="/assets/admin/img/gallery/2.jpeg" class="d-block w-100" alt="Slide 2">
                </div>
                <div class="carousel-item">
                  <img src="/assets/admin/img/gallery/3.jpeg" class="d-block w-100" alt="Slide 3">
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-md-4 mb-3">
          <div class="card card-body">
            <h6 class="text-center">With Controls</h6>
            <div id="carouselControls" class="carousel slide" data-ride="carousel">
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img src="/assets/admin/img/gallery/4.jpeg" class="d-block w-100" alt="Slide 4">
                </div>
                <div class="carousel-item">
                  <img src="/assets/admin/img/gallery/5.jpeg" class="d-block w-100" alt="Slide 5">
                </div>
                <div class="carousel-item">
                  <img src="/assets/admin/img/gallery/6.jpeg" class="d-block w-100" alt="Slide 6">
                </div>
              </div>
        ...
        <div class="col-md-4 mb-3">
          <div class="card card-body">
            <h6 class="text-center">With Indicators</h6>
            <div id="carouselIndicators" class="carousel slide" data-ride="carousel">
              ...
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img src="/assets/admin/img/gallery/7.jpeg" class="d-block w-100" alt="Slide 7">
                </div>
                <div class="carousel-item">
                  <img src="/assets/admin/img/gallery/8.jpeg" class="d-block w-100" alt="Slide 8">
                </div>
                <div class="carousel-item">
                  <img src="/assets/admin/img/gallery/9.jpeg" class="d-block w-100" alt="Slide 9">
                </div>
              </div>
        ...
        <div class="col-md-4 mb-3">
          <div class="card card-body">
            <h6 class="text-center">With Captions</h6>
            <div id="carouselCaptions" class="carousel slide" data-ride="carousel">
              ...
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img src="/assets/admin/img/gallery/10.jpeg" class="d-block w-100" alt="Slide 10">
        ...
        <div class="col-md-4 mb-3">
          <div class="card card-body">
            <h6 class="text-center">Crossfade</h6>
      ...
      <div class="row gutters-sm">
        ...
        <div class="col-md-4 mb-3">
          <div class="card card-body">
            <h6 class="text-center">With Navigation</h6>
        ...
        <div class="col-md-4 mb-3">
          <div class="card card-body">
            <h6 class="text-center">Small Navigation</h6>
        ...
        <div class="col-md-4 mb-3">
          <div class="card card-body">
            <h6 class="text-center">Autohide Navigation</h6>
        ...
        <div class="col-md-4 mb-3">
          <div class="card card-body">
            <h6 class="text-center">With Pagination</h6>
        ...
        <div class="col-md-4 mb-3">
          <div class="card card-body">
            <h6 class="text-center">Fraction Pagination</h6>
        ...
        <div class="col-md-4 mb-3">
          <div class="card card-body">
            <h6 class="text-center">Progressbar Pagination</h6>
        ...
        <div class="col-md-4 mb-3">
          <div class="card card-body">
            <h6 class="text-center">Fade Effect</h6>
        ...
        <div class="col-md-4 mb-3">
          <div class="card card-body">
            <h6 class="text-center">Coverflow Effect</h6>
        ...
        <div class="col-md-4 mb-3">
          <div class="card card-body">
            <h6 class="text-center">Flip Effect</h6>
        ...
        <div class="col-md-4 mb-3">
          <div class="card card-body">
            <h6 class="text-center">Cube Effect</h6>
        ...
        <div class="col-md-4 mb-3">
          <div class="card card-body" style="height: 280px">
            <h6 class="text-center">Vertical Slider</h6>
        ...
        <div class="col-md-4 mb-3">
          <div class="card card-body">
            <h6 class="text-center">With Navigation v2</h6>
            <div class="swiper-container" id="swiperNavigationV2">
              ...
              <div class="swiper-button-prev swiper-button-prev2 swiper-button-prev-sm"><i class="material-icons">chevron_left</i></div>
              <div class="swiper-button-next swiper-button-next2 swiper-button-next-sm"><i class="material-icons">chevron_right</i></div>
            </div>
          </div>
        </div>
      </div>
  ...
  <!-- Plugins -->
  <script src="/assets/admin/plugins/swiper/swiper.min.js"></script>
  <script>

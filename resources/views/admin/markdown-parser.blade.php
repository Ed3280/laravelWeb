      ...
      <ul class="nav treeview mb-4" data-accordion>
        ...
        <li class="nav-item">
          ...
          <ul class="nav">
            ...
            <li class="nav-item"><a href="markdown-parser.html" class="nav-link active">Markdown</a></li>
  ...
  <div class="main">
    ...
    <div class="main-body">
      ...
      <div class="row row-cols-1 row-cols-md-2">
        <div class="col mb-3">
          <textarea id="markdown" class="form-control">
# h1 Heading
## h2 Heading
### h3 Heading
#### h4 Heading
...
![Bird](/assets/admin/img/gallery/4swide.jpeg)
![Bird](/assets/admin/img/gallery/6swide.jpeg "The Bird")
...
[id]: /assets/admin/img/gallery/10swide.jpeg  "The Bird"</textarea>
        </div>
        <div class="col mb-3 markdown-result" id="markdown-result"></div>
      </div>
    </div>
    <!-- /Main body -->
  ...
  <script src="/assets/admin/plugins/markdown-it/markdown-it.min.js"></script>
  <script>

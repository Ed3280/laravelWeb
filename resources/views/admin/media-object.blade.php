      ...
      <ul class="nav treeview mb-4" data-accordion>
        ...
        <li class="nav-item">
          ...
          <ul class="nav">
            ...
            <li class="nav-item"><a href="media-object.html" class="nav-link active">Media Object</a></li>
        ...
        <div class="col">
          ...
          <section id="section1">
            ...
            <div class="card">
              <div class="card-body">
                <div class="media">
                  <img src="/assets/admin/img/user1.svg" class="mr-3 rounded-circle" width="75" alt="">
          ...
          <section id="section2">
            <h5>Nesting</h5>
            <p class="text-secondary font-size-sm">
              Media objects can be infinitely nested, though we suggest you stop at some point. Place nested <code>.media</code> within the <code>.media-body</code> of a parent media object.
            </p>
            <div class="card">
              <div class="card-body">
                <div class="media">
                  <img src="/assets/admin/img/user2.svg" class="mr-3 rounded-circle" width="75" alt="">
                  <div class="media-body">
                    <h5>Media heading</h5>
                    <p class="text-secondary font-size-sm mb-0">
                      Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.
                    ...
                    <div class="media mt-3">
                      <img src="/assets/admin/img/user3.svg" class="mr-3 rounded-circle" width="75" alt="">
                      <div class="media-body">
                        <h5>Media heading</h5>
                        <p class="text-secondary font-size-sm mb-0">
                          Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.
          ...
          <section id="section3">
            <h5>Alignment</h5>
            <p class="text-secondary font-size-sm">
              Media in a media object can be aligned with flexbox utilities to the top (default), middle, or end of your <code>.media-body</code> content.
            </p>
            <div class="card">
              <div class="card-body">
                <div class="media">
                  <img src="/assets/admin/img/user4.svg" class="align-self-start mr-3 rounded-circle" width="75" alt="">
                  <div class="media-body">
                    <h5>Top-aligned media</h5>
                    <p class="text-secondary font-size-sm">Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.</p>
                    <p class="text-secondary font-size-sm mb-0">Donec sed odio dui. Nullam quis risus eget urna mollis ornare vel eu leo. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.</p>
                  </div>
                </div>
              </div>
            </div>
            <div class="card mt-1">
              <div class="card-body">
                <div class="media">
                  <img src="/assets/admin/img/user5.svg" class="align-self-center mr-3 rounded-circle" width="75" alt="">
                  <div class="media-body">
            ...
            <div class="card mt-1">
              <div class="card-body">
                <div class="media">
                  <img src="/assets/admin/img/user1.svg" class="align-self-end mr-3 rounded-circle" width="75" alt="">
                  <div class="media-body">
            ...
            <div class="card">
              <div class="card-body">
                <ul class="list-unstyled">
                  ...
                  <hr>
                  <li class="media">
                    <img src="/assets/admin/img/user4.svg" class="mr-3 rounded-circle" width="75" alt="">
                    <div class="media-body">
                      <h5>Media heading</h5>
                      <p class="text-secondary font-size-sm mb-0">
                        Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.
                  ...
                  <hr>
                  <li class="media">
                    <img src="/assets/admin/img/user5.svg" class="mr-3 rounded-circle" width="75" alt="">
                    <div class="media-body">
                      <h5>Media heading</h5>
                      <p class="text-secondary font-size-sm mb-0">
                        Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.
        ...
        <div class="col-3 d-none d-xl-block">
          <div class="nav-section">
            ...
            <nav id="navSection" class="nav flex-column">
              ...
              <a href="#section2" class="nav-link nav-link-sm">Nesting</a>
              <a href="#section3" class="nav-link nav-link-sm">Alignment</a>
              <a href="#section4" class="nav-link nav-link-sm">Order</a>
              <a href="#section5" class="nav-link nav-link-sm">Media List</a>
            </nav>
          </div>
        </div>
      </div>

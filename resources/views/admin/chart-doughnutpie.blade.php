      ...
      <ul class="nav treeview mb-4" data-accordion>
        ...
        <li class="nav-item">
          ...
          <ul class="nav">
            ...
            <li class="nav-item"><a href="chart-doughnutpie.html" class="nav-link active">Doughnut and Pie</a></li>
    ...
    <div class="main-body">
      ...
      <nav aria-label="breadcrumb" class="main-breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">Doughnut and Pie</li>
        </ol>
      </nav>
      <!-- /Breadcrumb -->

      <h5>Doughnut and Pie Chart</h5>
      ...
      <div class="row row-cols-1 row-cols-md-2 gutters-sm">
        ...
        <div class="col mb-3">
          <div class="card">
            ...
            <div class="card-body" style="height: 300px">
              <canvas id="doughnut-basic"></canvas>
            </div>
          </div>
        </div>
        <!-- /DOUGHNUT BASIC -->
        ...
        <div class="col mb-3">
          <div class="card">
            ...
            <div class="card-body" style="height: 300px">
              <canvas id="doughnut-multi"></canvas>
            </div>
          </div>
        </div>
        <!-- /DOUGHNUT MULTI AXIS -->
        ...
        <div class="col mb-3">
          <div class="card">
            ...
            <div class="card-body" style="height: 300px">
              <canvas id="doughnut-semi"></canvas>
            </div>
          </div>
        </div>
        <!-- /DOUGHNUT SEMI CIRCLE -->

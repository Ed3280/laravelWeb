...
<head>
  ...
  <!-- Plugins -->
  <link rel="stylesheet" href="/assets/admin/plugins/fullcalendar/core/main.min.css">
  <link rel="stylesheet" href="/assets/admin/plugins/fullcalendar/daygrid/main.min.css">
  <link rel="stylesheet" href="/assets/admin/plugins/fullcalendar/timegrid/main.min.css">
  <link rel="stylesheet" href="/assets/admin/plugins/fullcalendar/list/main.min.css">
  <link rel="stylesheet" href="/assets/admin/plugins/fullcalendar/bootstrap/main.min.css">
  <!-- Main Style -->
...
<body>
  ...
  <div class="sidebar">
    ...
    <div class="sidebar-body">
      <ul class="nav treeview mb-4" data-accordion>
        ...
        <li class="nav-item">
          <a class="nav-link has-icon active" href="calendar.html"><i data-feather="calendar"></i>Calendar</a>
        </li>
        <li class="nav-item">
        ...
        <div class="col-lg-3 mb-3">
          <div class="card mb-3">
            <div class="card-header py-1 border-0">
              <h6>Create Event</h6>
              <button type="button" data-action="collapse" data-target="#card-body" data-toggle="collapse" aria-expanded="false" class="btn btn-sm btn-text-secondary btn-icon rounded-circle ml-auto">
  ...
  <!-- Plugins -->
  <script src="/assets/admin/plugins/fullcalendar/core/main.min.js"></script>
  <script src="/assets/admin/plugins/fullcalendar/daygrid/main.min.js"></script>
  <script src="/assets/admin/plugins/fullcalendar/timegrid/main.min.js"></script>
  <script src="/assets/admin/plugins/fullcalendar/list/main.min.js"></script>
  <script src="/assets/admin/plugins/fullcalendar/bootstrap/main.min.js"></script>
  <script src="/assets/admin/plugins/fullcalendar/interaction/main.min.js"></script>
  <script>

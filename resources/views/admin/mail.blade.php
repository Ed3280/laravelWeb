  ...
  <div class="sidebar">
    ...
    <div class="sidebar-body">
      <ul class="nav treeview mb-4" data-accordion>
        ...
        <li class="nav-item">
          <a class="nav-link has-icon active" href="mail.html"><i class="material-icons">mail_outline</i>Mail<span class="badge badge-warning ml-auto badge-pill">3</span></a>
        </li>
        <li class="nav-item">
            ...
            <div class="card rounded-0">
              <div class="card-body font-size-sm">
                <div class="media mb-3 align-items-center">
                  <img src="/assets/admin/img/user.svg" alt="User" class="rounded" width="50" height="50">

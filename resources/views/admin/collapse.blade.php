      ...
      <ul class="nav treeview mb-4" data-accordion>
        ...
        <li class="nav-item">
          ...
          <ul class="nav">
            ...
            <li class="nav-item"><a href="collapse.html" class="nav-link active">Collapse</a></li>
  ...
  <div class="main">
    ...
    <div class="main-body">
      ...
      <section class="pb-5">
        ...
        <p class="text-secondary font-size-sm">
          A button or link can show and hide multiple elements by referencing them with a jquery selector in its href or
      ...
      <section class="pb-5">
        <h5>No animation</h5>
        <p class="text-secondary font-size-sm">
          Disable animation transition with <code>.transition-none</code> class.
        </p>
        <p>
          <button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#collapseNoAnimation" aria-expanded="false" aria-controls="collapseNoAnimation">
            Toggle
          </button>
        </p>
        <div class="collapse transition-none" id="collapseNoAnimation">
          <div class="card card-body">
            Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. Nihil anim
            keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident.
          </div>

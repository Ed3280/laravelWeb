            ...
            <div class="card-body">
              <section id="section1">
                ...
                <p class="text-muted font-size-sm">
                  ...
                  <a href="https://material.io/resources/icons" target="_blank">https://material.io/resources/icons</a>
                </p>
                <div class="list-with-gap">
                  ...
                  <i class="material-icons">text_rotation_angledown</i>
                  <i class="material-icons">text_rotation_angleup</i>
            ...
            <div class="card-body">
              <section id="section2">
                ...
                <p class="text-muted font-size-sm">
                  ...
                  <a href="https://feathericons.com/" target="_blank">https://feathericons.com/</a>
                </p>
                <div class="list-with-gap">
            ...
            <div class="card-body">
              <section id="section3">
                ...
                <p class="text-muted font-size-sm">
                  ...
                  <a href="https://fontawesome.com/cheatsheet/free/" target="_blank">https://fontawesome.com/cheatsheet/free/</a>
                </p>
              </section>
              <div class="list-with-gap">
                <i class="fa fa-fw fa-ad"></i>
                <i class="fa fa-fw fa-address-book"></i>
                <i class="fa fa-fw fa-address-card"></i>
                <i class="fa fa-fw fa-adjust"></i>
                <i class="fa fa-fw fa-air-freshener"></i>
                <i class="fa fa-fw fa-align-center"></i>
                <i class="fa fa-fw fa-align-justify"></i>
                <i class="fa fa-fw fa-align-left"></i>
                <i class="fa fa-fw fa-align-right"></i>
                <i class="fa fa-fw fa-allergies"></i>
                ...
                <i class="fa fa-fw fa-angry"></i>
                <i class="fa fa-fw fa-ankh"></i>
                <i class="fa fa-fw fa-apple-alt"></i>
              ...
              <div class="list-with-gap">
                ...
                <i class="fab fa-fw fa-acquisitions-incorporated"></i>
                <i class="fab fa-fw fa-adn"></i>
                <i class="fab fa-fw fa-adobe"></i>
                ...
                <i class="fab fa-fw fa-atlassian"></i>
        ...
        <div class="col-3 d-none d-xl-block">
          <div class="nav-section">
            ...
            <nav id="navSection" class="nav flex-column">
              <a href="#section1" class="nav-link nav-link-sm">Material Icons</a>
              <a href="#section2" class="nav-link nav-link-sm">Feather Icons</a>
              <a href="#section3" class="nav-link nav-link-sm">Fontawesome</a>
            </nav>
          </div>
        </div>
      </div>

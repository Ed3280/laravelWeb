      ...
      <ul class="nav treeview mb-4" data-accordion>
        ...
        <li class="nav-item">
          ...
          <ul class="nav">
            ...
            <li class="nav-item"><a href="navigation.html" class="nav-link active">Navigation</a></li>
            ...
            <div class="card-body">
              <section id="section1">
                ...
                <ul class="nav nav-gap-x-1">
                  ...
                  <li class="nav-item">
                    <a class="nav-link has-icon" href="javascript:void(0)"><i data-feather="tag" class="mr-1"></i></i>With icon</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link nav-link-img" href="javascript:void(0)">
                      <img src="/assets/admin/img/gallery/1s.jpeg" alt="img" class="rounded-circle mr-2"> With image
                    </a>
                  </li>
                  <li class="nav-item">
                ...
                <ul class="nav nav-pills nav-gap-x-1 mt-3">
                  <li class="nav-item">
                    <a class="nav-link active" href="javascript:void(0)">Active</a>
                  </li>
                  <li class="nav-item">
                ...
                <ul class="nav nav-gap-x-1 mt-3">
                  <li class="nav-item">
                    <a class="nav-link nav-link-faded active" href="javascript:void(0)">Active</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link nav-link-faded" href="javascript:void(0)">Link</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link nav-link-faded has-icon" href="javascript:void(0)"><i data-feather="tag" class="mr-1"></i></i>With icon</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link nav-link-faded nav-link-img" href="javascript:void(0)">
                      <img src="/assets/admin/img/gallery/1s.jpeg" alt="img" class="rounded-circle mr-2"> With image
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link nav-link-faded disabled" href="javascript:void(0)" tabindex="-1" aria-disabled="true">Disabled</a>
                  </li>
                </ul>
              </section>
            </div>
          ...
          <div class="card mt-5">
            <div class="card-body">
              <section id="section2">
                <h5>Alignment</h5>
                <p class="text-muted font-size-sm">
                  By default, navs are left-aligned, but you can easily change them to center, right or vertical aligned.
                </p>
                <ul class="nav nav-gap-x-1 justify-content-center">
                  <li class="nav-item">
                    <a class="nav-link nav-link-faded active" href="javascript:void(0)">Active</a>
                  </li>
                  <li class="nav-item">
                ...
                <ul class="nav nav-gap-x-1 justify-content-end mt-3">
                  <li class="nav-item">
                    <a class="nav-link nav-link-faded active" href="javascript:void(0)">Active</a>
                  </li>
                  <li class="nav-item">
                ...
                <ul class="nav nav-gap-y-1 flex-column mt-3" style="max-width: 200px">
                  <li class="nav-item">
                    <a class="nav-link nav-link-faded active" href="javascript:void(0)">Active</a>
                  </li>
                  <li class="nav-item">
            ...
            <div class="card-body">
              <section id="section3">
                ...
                <nav class="nav nav-gap-x-1">
                  <a class="nav-link nav-icon active" href="javascript:void(0)"><i data-feather="grid"></i></a>
                  <a class="nav-link nav-icon" href="javascript:void(0)"><i data-feather="user"></i></a>
                  <a class="nav-link nav-icon" href="javascript:void(0)"><i data-feather="phone"></i></a>
                  <a class="nav-link nav-icon disabled" href="#" tabindex="-1" aria-disabled="true"><i data-feather="slash"></i></a>
                </nav>
                <nav class="nav nav-pills nav-gap-x-1 mt-3">
                  <a class="nav-link nav-icon active" href="javascript:void(0)"><i data-feather="grid"></i></a>
                  <a class="nav-link nav-icon" href="javascript:void(0)"><i data-feather="user"></i></a>
                  <a class="nav-link nav-icon" href="javascript:void(0)"><i data-feather="phone"></i></a>
                  <a class="nav-link nav-icon disabled" href="#" tabindex="-1" aria-disabled="true"><i data-feather="slash"></i></a>
                </nav>
                <nav class="nav nav-gap-x-1 mt-3">
                  <a class="nav-link nav-link-faded nav-icon active" href="javascript:void(0)"><i data-feather="grid"></i></a>
                  <a class="nav-link nav-link-faded nav-icon" href="javascript:void(0)"><i data-feather="user"></i></a>
                  <a class="nav-link nav-link-faded nav-icon" href="javascript:void(0)"><i data-feather="phone"></i></a>
                  <a class="nav-link nav-link-faded nav-icon disabled" href="#" tabindex="-1" aria-disabled="true"><i data-feather="slash"></i></a>
                </nav>
              </section>
            </div>
          </div>
          ...
          <div class="card mt-5">
            <div class="card-body">
              <section id="section4">
                <h5>Circle style</h5>
                <p class="text-muted font-size-sm">
                  Instead of adding styles to each link, make all links a circle style by adding the <code>.nav-circle</code> class
                </p>
                <nav class="nav nav-pills nav-circle nav-gap-x-1">
                  <a class="nav-link nav-icon active" href="javascript:void(0)"><i data-feather="grid"></i></a>
                  <a class="nav-link nav-icon" href="javascript:void(0)"><i data-feather="user"></i></a>
                  <a class="nav-link nav-icon" href="javascript:void(0)"><i data-feather="phone"></i></a>
                  <a class="nav-link nav-icon disabled" href="#" tabindex="-1" aria-disabled="true"><i data-feather="slash"></i></a>
                </nav>
                <nav class="nav nav-circle nav-gap-x-1 mt-3">
                  <a class="nav-link nav-link-faded nav-icon active" href="javascript:void(0)"><i data-feather="grid"></i></a>
                  <a class="nav-link nav-link-faded nav-icon" href="javascript:void(0)"><i data-feather="user"></i></a>
                  <a class="nav-link nav-link-faded nav-icon" href="javascript:void(0)"><i data-feather="phone"></i></a>
                  <a class="nav-link nav-link-faded nav-icon disabled" href="#" tabindex="-1" aria-disabled="true"><i data-feather="slash"></i></a>
          ...
          <div class="card mt-5">
            <div class="card-body">
              <section id="section5">
                <h5>Tabs</h5>
                <p class="text-muted font-size-sm">
                  Takes the basic nav and adds the <code>.nav-tabs</code> class to generate a tabbed interface.
                </p>
                ...
                <ul class="nav nav-pills nav-gap-x-1 mt-3" role="tablist">
                  <li class="nav-item">
                    <a class="nav-link active" id="home-tab-pills" data-toggle="tab" href="#homePills" role="tab" aria-controls="homePills" aria-selected="true">Home</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" id="profile-tab-pills" data-toggle="tab" href="#profilePills" role="tab" aria-controls="profilePills" aria-selected="false">Profile</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" id="contact-tab-pills" data-toggle="tab" href="#contactPills" role="tab" aria-controls="contactPills" aria-selected="false">Contact</a>
                  </li>
                </ul>
                <div class="tab-content">
                  <div class="tab-pane fade show active" id="homePills" role="tabpanel" aria-labelledby="home-tab-pills">
                    home content here
                  </div>
                  <div class="tab-pane fade" id="profilePills" role="tabpanel" aria-labelledby="profile-tab-pills">
                    profile content here
                  </div>
                  <div class="tab-pane fade" id="contactPills" role="tabpanel" aria-labelledby="contact-tab-pills">
                    contact content here
                  </div>
                </div>
                <ul class="nav nav-gap-x-1 mt-3" role="tablist">
                  <li class="nav-item">
                    <a class="nav-link nav-link-faded active" id="home-tab-faded" data-toggle="tab" href="#homeFaded" role="tab" aria-controls="homeFaded" aria-selected="true">Home</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link nav-link-faded" id="profile-tab-faded" data-toggle="tab" href="#profileFaded" role="tab" aria-controls="profileFaded" aria-selected="false">Profile</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link nav-link-faded" id="contact-tab-faded" data-toggle="tab" href="#contactFaded" role="tab" aria-controls="contactFaded" aria-selected="false">Contact</a>
                  </li>
                </ul>
                <div class="tab-content">
                  <div class="tab-pane fade show active" id="homeFaded" role="tabpanel" aria-labelledby="home-tab-faded">
                    home content here
                  </div>
                ...
                <p class="text-muted font-size-sm mt-5">Simple style</p>
                <ul class="nav nav-tabs nav-tabs-simple" id="mySimpleTab" role="tablist">
                  <li class="nav-item">
                    <a class="nav-link active" id="home-tab-simple" data-toggle="tab" href="#homeSimple" role="tab" aria-controls="home" aria-selected="true">Home</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" id="profile-tab-simple" data-toggle="tab" href="#profileSimple" role="tab" aria-controls="profile" aria-selected="false">Profile</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" id="contact-tab-simple" data-toggle="tab" href="#contactSimple" role="tab" aria-controls="contact" aria-selected="false">Contact</a>
                  </li>
                </ul>
                <div class="tab-content" id="mySimpleTabContent">
                  <div class="tab-pane fade show active" id="homeSimple" role="tabpanel" aria-labelledby="home-tab-simple">
                    home content here
                  </div>
                  <div class="tab-pane fade" id="profileSimple" role="tabpanel" aria-labelledby="profile-tab-simple">
                    profile content here
                  </div>
                  <div class="tab-pane fade" id="contactSimple" role="tabpanel" aria-labelledby="contact-tab-simple">
                    contact content here
                  </div>
                </div>
                <p class="text-muted font-size-sm mt-5">Vertical</p>
                <div class="row gutters-sm">
                  <div class="col-6 col-sm-4">
                    <nav class="nav nav-gap-y-1 flex-column">
                      <a class="nav-item nav-link nav-link-faded has-icon" href="#home3_i" data-toggle="tab"><i data-feather="grid" class="mr-2"></i>Home</a>
                      <a class="nav-item nav-link nav-link-faded has-icon active" href="#profile3_i" data-toggle="tab"><i data-feather="user" class="mr-2"></i>Profile</a>
                      <a class="nav-item nav-link nav-link-faded has-icon" href="#contact3_i" data-toggle="tab"><i data-feather="phone" class="mr-2"></i>Contact</a>
                      <a class="nav-item nav-link nav-link-faded has-icon disabled" href="#" tabindex="-1" aria-disabled="true"><i data-feather="slash" class="mr-2"></i>Disabled</a>
                    </nav>
                  </div>
                  <div class="col-6 col-sm-8 bg-gray-200">
                    <div class="tab-content">
                      <div class="tab-pane show" id="home3_i">home content</div>
                      <div class="tab-pane active" id="profile3_i">profile content</div>
              ...
              <section id="section6">
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-gray-100">
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav nav-gap-x-1 mr-auto">
                      <li class="nav-item active">
                        <a class="nav-link active" href="javascript:void(0)">Active <span class="sr-only">(current)</span></a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" href="javascript:void(0)">Link</a>
                      </li>
                ...
                <p class="text-muted font-size-sm mt-5">Color schemes</p>
        ...
        <div class="col-3 d-none d-xl-block">
          <div class="nav-section">
            ...
            <nav id="navSection" class="nav flex-column">
              ...
              <a href="#section2" class="nav-link nav-link-sm">Alignment</a>
              <a href="#section3" class="nav-link nav-link-sm">Icon only</a>
              <a href="#section4" class="nav-link nav-link-sm">Circle style</a>
              <a href="#section5" class="nav-link nav-link-sm">Tabs</a>
              <a href="#section6" class="nav-link nav-link-sm">Navbar</a>
            </nav>
          </div>
        </div>
      </div>

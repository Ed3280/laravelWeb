      ...
      <ul class="nav treeview mb-4" data-accordion>
        ...
        <li class="nav-item">
          ...
          <ul class="nav">
            ...
            <li class="nav-item"><a href="spinners.html" class="nav-link active">Spinners</a></li>
      ...
      <div class="row">
        <div class="col">
          ...
          <section id="section3" class="mt-5">
            <h5>Colors</h5>
            <p class="text-secondary font-size-sm">
              Spinner is built with <code>currentColor</code>, so you can easily change its appearance with text color utilities.
            </p>
            <div class="card card-body">
          ...
          <section id="section4" class="mt-5">
            <h5>Size</h5>
            <p class="text-secondary font-size-sm">
              Add <code>.spinner-border-sm</code> and <code>.spinner-grow-sm</code> to make a smaller spinner that can quickly be used within other components.
            </p>
            <div class="card card-body">
              <div class="list-with-gap">
        ...
        <div class="col-3 d-none d-xl-block">
          <div class="nav-section">
            ...
            <nav id="navSection" class="nav flex-column">
              <a href="#section1" class="nav-link nav-link-sm">Border Spinner</a>
              <a href="#section2" class="nav-link nav-link-sm">Growing Spinner</a>
              <a href="#section3" class="nav-link nav-link-sm">Colors</a>
              <a href="#section4" class="nav-link nav-link-sm">Size</a>
              <a href="#section5" class="nav-link nav-link-sm">Buttons</a>
            </nav>
          </div>
        </div>
      </div>

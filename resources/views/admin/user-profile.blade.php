    ...
    <div class="sidebar-body">
      <ul class="nav treeview mb-4" data-accordion>
        ...
        <li class="nav-item">
          ...
          <ul class="nav">
            <li class="nav-item"><a href="user-profile.html" class="nav-link active">User Profile</a></li>
          ...
          <div class="card">
            <div class="card-body">
              <div class="d-flex flex-column align-items-center text-center">
                <img src="/assets/admin/img/user.svg" alt="Admin" class="rounded-circle" width="150">
                <div class="mt-3">
          ...
          <div class="card mt-3">
            <ul class="list-group list-group-flush">
              <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                <h6 class="mb-0"><i class="mr-2 icon-inline" data-feather="globe"></i>Website</h6>
                <span class="text-secondary">http://benije.ke/pozzivkij</span>
              </li>
              <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                <h6 class="mb-0"><i class="mr-2 icon-inline" data-feather="github"></i>Github</h6>
                <span class="text-secondary">kennethvaldez</span>
              </li>
              <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                <h6 class="mb-0"><i class="mr-2 icon-inline text-info" data-feather="twitter"></i>Twitter</h6>
                <span class="text-secondary">@kennethvaldez</span>
              </li>
              <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                <h6 class="mb-0"><i class="mr-2 icon-inline text-danger" data-feather="instagram"></i>Instagram</h6>
                <span class="text-secondary">kennethvaldez</span>
              </li>
              <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">

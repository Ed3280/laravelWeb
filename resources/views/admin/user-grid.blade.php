  ...
  <div class="sidebar">
    ...
    <div class="sidebar-body">
      <ul class="nav treeview mb-4" data-accordion>
        ...
        <li class="nav-item">
          <a class="nav-link has-icon treeview-toggle active show" href="#"><i data-feather="users"></i>User</a>
          <ul class="nav">
            ...
            <li class="nav-item"><a href="user-grid.html" class="nav-link active">User Grid</a></li>
  ...
  <div class="main">
    ...
    <div class="main-body">
      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-xl-4 gutters-sm">
        <div class="col mb-3">
          <div class="card">
            <img src="/assets/admin/img/pattern/pattern1-wide.png" alt="Cover" class="card-img-top">
            <div class="card-body text-center">
              <img src="/assets/admin/img/user.svg" style="width:100px;margin-top:-65px" alt="User" class="img-fluid img-thumbnail rounded-circle border-0 mb-3">
              <h5 class="card-title">Kenneth Valdez</h5>
            ...
            <div class="card-footer">
              ...
              <button class="btn btn-light btn-sm bg-white has-icon ml-2" type="button"><i data-feather="message-circle"></i></button>
            </div>
          </div>
        </div>
        <div class="col mb-3">
          <div class="card">
            <img src="/assets/admin/img/pattern/pattern2-wide.png" alt="Cover" class="card-img-top">
            <div class="card-body text-center">
              <img src="/assets/admin/img/user1.svg" style="width:100px;margin-top:-65px" alt="User" class="img-fluid img-thumbnail rounded-circle border-0 mb-3">
              <h5 class="card-title">Kenneth Valdez</h5>
              <p class="text-secondary mb-1">Full Stack Developer</p>
              <p class="text-muted font-size-sm">Bay Area, San Francisco, CA</p>
            </div>
        ...
        <div class="col mb-3">
          <div class="card">
            <img src="/assets/admin/img/pattern/pattern3-wide.png" alt="Cover" class="card-img-top">
            <div class="card-body text-center">
              <img src="/assets/admin/img/user2.svg" style="width:100px;margin-top:-65px" alt="User" class="img-fluid img-thumbnail rounded-circle border-0 mb-3">
              <h5 class="card-title">Kenneth Valdez</h5>
              <p class="text-secondary mb-1">Full Stack Developer</p>
              <p class="text-muted font-size-sm">Bay Area, San Francisco, CA</p>
            </div>
        ...
        <div class="col mb-3">
          <div class="card">
            <img src="/assets/admin/img/pattern/pattern4-wide.png" alt="Cover" class="card-img-top">
            <div class="card-body text-center">
              <img src="/assets/admin/img/user3.svg" style="width:100px;margin-top:-65px" alt="User" class="img-fluid img-thumbnail rounded-circle border-0 mb-3">
              <h5 class="card-title">Kenneth Valdez</h5>
              <p class="text-secondary mb-1">Full Stack Developer</p>
              <p class="text-muted font-size-sm">Bay Area, San Francisco, CA</p>
            </div>
        ...
        <div class="col mb-3">
          <div class="card">
            <img src="/assets/admin/img/pattern/pattern5-wide.png" alt="Cover" class="card-img-top">
            <div class="card-body text-center">
              <img src="/assets/admin/img/user4.svg" style="width:100px;margin-top:-65px" alt="User" class="img-fluid img-thumbnail rounded-circle border-0 mb-3">
              <h5 class="card-title">Kenneth Valdez</h5>
              <p class="text-secondary mb-1">Full Stack Developer</p>
              <p class="text-muted font-size-sm">Bay Area, San Francisco, CA</p>
            </div>
        ...
        <div class="col mb-3">
          <div class="card">
            <img src="/assets/admin/img/pattern/pattern6-wide.png" alt="Cover" class="card-img-top">
            <div class="card-body text-center">
              <img src="/assets/admin/img/user5.svg" style="width:100px;margin-top:-65px" alt="User" class="img-fluid img-thumbnail rounded-circle border-0 mb-3">
              <h5 class="card-title">Kenneth Valdez</h5>
              <p class="text-secondary mb-1">Full Stack Developer</p>
              <p class="text-muted font-size-sm">Bay Area, San Francisco, CA</p>
            </div>

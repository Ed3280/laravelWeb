      ...
      <ul class="nav treeview mb-4" data-accordion>
        ...
        <li class="nav-item">
          ...
          <ul class="nav">
            ...
            <li class="nav-item"><a href="user-list.html" class="nav-link active">User List</a></li>
    ...
    <div class="main-body">
      ...
      <div class="d-flex">
        <div class="list-with-gap">
          <button class="btn btn-primary has-icon" type="button" data-toggle="modal" data-target="#addUser"><i class="material-icons mr-2">add_circle_outline</i>Add new user</button>
      ...
      <div class="card mt-3">
        <div class="table-responsive">
          <table class="table table-nostretch table-align-middle mb-0">
            <thead>
              <tr class="column-filter" id="filter" hidden>
                <th></th>
                <th><input type="text" class="form-control" placeholder="Search User Fullname"></th>
                ...
                <th><button class="btn btn-outline-primary btn-block has-icon"><i class="material-icons">search</i></button></th>
              </tr>
              <tr>
                <th scope="col" class="text-center">Avatar</th>
                <th scope="col"><a href="javascript:void(0)" class="sorting asc">User Fullname</a></th>
                <th scope="col"><a href="javascript:void(0)" class="sorting">Mobile</a></th>
                <th scope="col"><a href="javascript:void(0)" class="sorting">Email</a></th>
            ...
            <tbody>
              <tr>
                <td class="text-center"><img src="/assets/admin/img/user1.svg" alt="user" class="rounded-circle" width="40"></td>
                <td>Dennis Castro</td>
                <td>(887) 547-5112</td>
                <td>ewusa@cuzuc.pe</td>
              ...
              <tr>
                <td class="text-center"><img src="/assets/admin/img/user2.svg" alt="user" class="rounded-circle" width="40"></td>
                <td>Derrick Reyes</td>
                <td>(849) 999-3741</td>
                <td>wedaom@hef.cz</td>
                <td class="text-center"><span class="badge badge-pill badge-success">Active</span></td>
              ...
              <tr>
                <td class="text-center"><img src="/assets/admin/img/user3.svg" alt="user" class="rounded-circle" width="40"></td>
                <td>Jeffrey Henderson</td>
                <td>(358) 919-1298</td>
                <td>tevamvud@vigzos.mh</td>
                <td class="text-center"><span class="badge badge-pill badge-success">Active</span></td>
                <td class="text-center">
                  <div class="btn-group btn-group-sm" role="group">
                    <a href="javascript:void(0)" class="btn btn-link btn-icon bigger-130 text-primary" title="Detail"><i class="material-icons">visibility</i></a>
              ...
              <tr>
                <td class="text-center"><img src="/assets/admin/img/user4.svg" alt="user" class="rounded-circle" width="40"></td>
                <td>Hallie Williamson</td>
                <td>(710) 490-1360</td>
                <td>owo@wijrij.gh</td>
              ...
              <tr>
                <td class="text-center"><img src="/assets/admin/img/user5.svg" alt="user" class="rounded-circle" width="40"></td>
                <td>Jackson Swanson</td>
                <td>(582) 575-8628</td>
                <td>noltun@zectikde.gf</td>
                <td class="text-center"><span class="badge badge-pill badge-success">Active</span></td>
                <td class="text-center">
                  <div class="btn-group btn-group-sm" role="group">
                    <a href="javascript:void(0)" class="btn btn-link btn-icon bigger-130 text-primary" title="Detail"><i class="material-icons">visibility</i></a>

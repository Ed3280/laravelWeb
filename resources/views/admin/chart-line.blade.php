    ...
    <div class="sidebar-body">
      <ul class="nav treeview mb-4" data-accordion>
        ...
        <li class="nav-item">
          ...
          <ul class="nav">
            <li class="nav-item"><a href="chart-line.html" class="nav-link active">Line Charts</a></li>
      ...
      <div class="row row-cols-1 row-cols-md-2 gutters-sm">
        ...
        <div class="col mb-3">
          <div class="card">
            ...
            <div class="card-body" style="height: 300px">
              <canvas id="line-chart-basic"></canvas>
            </div>
          </div>
        </div>
        <!-- /BASIC -->
        ...
        <div class="col mb-3">
          <div class="card">
            ...
            <div class="card-body" style="height: 300px">
              <canvas id="line-chart-straightlines"></canvas>
            </div>
          </div>
        </div>
        <!-- /STRAIGHTLINES -->
        ...
        <div class="col mb-3">
          <div class="card">
            ...
            <div class="card-body" style="height: 300px">
              <canvas id="line-chart-multi"></canvas>
            </div>
          </div>
        </div>
        <!-- /MULTI AXIS -->
        ...
        <div class="col mb-3">
          <div class="card">
            ...
            <div class="card-body" style="height: 300px">
              <canvas id="line-chart-dash"></canvas>
            </div>
          </div>
        </div>
        <!-- /DASH LINES -->
        ...
        <div class="col mb-3">
          <div class="card">
            <div class="card-header">
              Point Style:
              <select class="custom-select custom-select-sm w-auto ml-3" id="pointStyle">
            ...
            <div class="card-body" style="height: 300px">
              <canvas id="line-chart-point-style"></canvas>
            </div>
          </div>
        </div>
        <!-- /POINT STYLES -->

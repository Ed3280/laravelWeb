  ...
  <div class="sidebar">
    ...
    <div class="sidebar-body">
      <ul class="nav treeview mb-4" data-accordion>
        ...
        <li class="nav-item">
          <a class="nav-link has-icon active" href="index2.html"><i data-feather="shopping-bag"></i>Sales Monitoring</a>
        </li>
        ...
        <div class="col-md-6 col-xl-4 mb-3">
          <div class="card h-100 overflow-hidden" id="new-customers">
            ...
            <ul class="list-group list-group-flush">
              ...
              <li class="list-group-item d-flex align-items-center">
                <div class="media">
                  <img src="/assets/admin/img/user4.svg" alt="user" class="rounded-circle" width="40">
                  <div class="media-body ml-2">
              ...
              <li class="list-group-item d-flex align-items-center">
                <div class="media">
                  <img src="/assets/admin/img/user5.svg" alt="user" class="rounded-circle" width="40">
                  <div class="media-body ml-2">

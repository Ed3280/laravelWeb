      ...
      <ul class="nav treeview mb-4" data-accordion>
        ...
        <li class="nav-item">
          ...
          <ul class="nav">
            ...
            <li class="nav-item"><a href="tooltips.html" class="nav-link active">Tooltips</a></li>
      ...
      <div class="card">
        <div class="card-body">
          <section>
            ...
            <p class="text-muted font-size-sm">Four options are available: top, right, bottom, and left aligned.</p>
            <div class="d-flex justify-content-around">
              <button type="button" class="btn btn-sm btn-light" data-toggle="tooltip" data-placement="top" title="Tooltip on top">
                Top
              </button>
              <button type="button" class="btn btn-sm btn-light" data-toggle="tooltip" data-placement="right" title="Tooltip on right">
                Right
              </button>
              <button type="button" class="btn btn-sm btn-light" data-toggle="tooltip" data-placement="bottom" title="Tooltip on bottom">
                Bottom
              </button>
              <button type="button" class="btn btn-sm btn-light" data-toggle="tooltip" data-placement="left" title="Tooltip on left">
                Left
              </button>
            </div>
          </section>
          ...
          <section>
            ...
            <p class="text-muted font-size-sm">A custom style variant to create a full colored background of popover. Available in all four directions.</p>
            <div class="d-flex justify-content-around">
              <button type="button" class="btn btn-sm btn-primary" title="Primary Tooltip" data-toggle="tooltip-primary" data-placement="top">
                Primary
              </button>
              <button type="button" class="btn btn-sm btn-success" title="Success Tooltip" data-toggle="tooltip-success" data-placement="top">
                Success
              </button>
              <button type="button" class="btn btn-sm btn-warning" title="Warning Tooltip" data-toggle="tooltip-warning" data-placement="top">
                Warning
              </button>
            </div>
            <div class="d-flex justify-content-around mt-3">
              <button type="button" class="btn btn-sm btn-danger" title="Danger Tooltip" data-toggle="tooltip-danger" data-placement="bottom">
                Danger
              </button>
              <button type="button" class="btn btn-sm btn-info" title="Info Tooltip" data-toggle="tooltip-info" data-placement="bottom">
                Info
              </button>
              <button type="button" class="btn btn-sm btn-secondary" title="Secondary Tooltip" data-toggle="tooltip-secondary" data-placement="bottom">
                Secondary
              </button>
            </div>
          </section>
